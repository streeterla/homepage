...
function Parallax_One_theme_updater() {
    ...
    $edd_updater = new Parallax_One_Theme_Updater( array(
...
add_action( 'admin_init', 'Parallax_One_theme_updater' );

if(!class_exists('Parallax_One_Theme_Updater')) {
    class Parallax_One_Theme_Updater {
