...
<?php if ( have_comments() ) : ?>
	...
	<h2 id="comments" class="archive_title">Diskussion <span class="comment-count"><a class="comment-link" href="<?php comments_link(); ?>"></a> <?php comments_number('0','1','%'); ?></span></h2>

	<ol class="commentlist">
		<?php wp_list_comments('reply_text=Auf diesen Kommentar antworten&max_depth='.$thread_comments_depth.'&style=ul&type=all&avatar_size=70&reverse_top_level=true&callback=spd_comments'); ?>
	</ol>
