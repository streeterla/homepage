Ext.data.JsonP.Ext_form_field_TextArea({
  "static": false,
  "mixedInto": [
  ...
  "href": "TextArea.html#Ext-form-field-TextArea",
  "subclasses": [
  ...
  "members": {
    ...
    "cfg": [
      {
        ...
        "doc": "<p>If specified, then the component will be displayed with this value as its active error when\nfirst rendered. Defaults to undefined. Use <a href=\"#/api/Ext.form.field.TextArea-method-setActiveError\" rel=\"Ext.form.field.TextArea-method-setActiveError\" class=\"docClass\">setActiveError</a> or <a href=\"#/api/Ext.form.field.TextArea-method-unsetActiveError\" rel=\"Ext.form.field.TextArea-method-unsetActiveError\" class=\"docClass\">unsetActiveError</a> to\nchange it after component creation.</p>\n"
      },
      {
        "static": false,
        "type": "Ext.XTemplate",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The template used to format the Array of error messages passed to <a href=\"#/api/Ext.form.field.TextArea-method-setActiveErrors\" rel=\"Ext.form.field.TextArea-method-setActiveErrors\" class=\"docClass\">setActiveErrors</a>\ninto a single HTML string. By default this renders each message as an item in an unordered list.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "doc": "<p>A tag name or <a href=\"#/api/Ext.DomHelper\" rel=\"Ext.DomHelper\" class=\"docClass\">DomHelper</a> spec used to create the <a href=\"#/api/Ext.form.field.TextArea-method-getEl\" rel=\"Ext.form.field.TextArea-method-getEl\" class=\"docClass\">Element</a> which will\nencapsulate this Component.</p>\n\n\n<p>You do not normally need to specify this. For the base classes <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Ext.Component</a> and <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Ext.container.Container</a>,\nthis defaults to <b><tt>'div'</tt></b>. The more complex Sencha classes use a more complex\nDOM structure specified by their own <a href=\"#/api/Ext.form.field.TextArea-cfg-renderTpl\" rel=\"Ext.form.field.TextArea-cfg-renderTpl\" class=\"docClass\">renderTpl</a>s.</p>\n\n\n<p>This is intended to allow the developer to create application-specific utility Components encapsulated by\ndifferent DOM elements. Example usage:</p>\n\n\n<pre><code>{\n    xtype: 'component',\n    autoEl: {\n        tag: 'img',\n        src: 'http://www.example.com/example.jpg'\n    }\n}, {\n    xtype: 'component',\n    autoEl: {\n        tag: 'blockquote',\n        html: 'autoEl is cool!'\n    }\n}, {\n    xtype: 'container',\n    autoEl: 'ul',\n    cls: 'ux-unordered-list',\n    items: {\n        xtype: 'component',\n        autoEl: 'li',\n        html: 'First list item'\n    }\n}\n</code></pre>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Whether to adjust the component's body area to make room for 'side' or 'under'\n<a href=\"#/api/Ext.form.field.TextArea-cfg-msgTarget\" rel=\"Ext.form.field.TextArea-cfg-msgTarget\" class=\"docClass\">error messages</a>. Defaults to <tt>true</tt>.</p>\n"
      },
      {
        "static": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>This config is intended mainly for <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Components which may or may not be shown. Instead\nof using <a href=\"#/api/Ext.form.field.TextArea-cfg-renderTo\" rel=\"Ext.form.field.TextArea-cfg-renderTo\" class=\"docClass\">renderTo</a> in the configuration, and rendering upon construction, this allows a Component\nto render itself upon first <i><a href=\"#/api/Ext.form.field.TextArea-method-show\" rel=\"Ext.form.field.TextArea-method-show\" class=\"docClass\">show</a></i>.</p>\n\n\n<p>Specify as <code>true</code> to have this Component render to the document body upon first show.</p>\n\n\n<p>Specify as an element, or the ID of an element to have this Component render to a specific element upon first show.</p>\n\n\n<p><b>This defaults to <code>true</code> for the <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a> class.</b></p>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>True to automatically show the component upon creation.\nThis config option may only be used for <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> components or components\nthat use <a href=\"#/api/Ext.form.field.TextArea-cfg-autoRender\" rel=\"Ext.form.field.TextArea-cfg-autoRender\" class=\"docClass\">autoRender</a>. Defaults to <tt>false</tt>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "name": "blankText",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>The error text to display if the <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-allowBlank\" rel=\"Ext.form.field.TextArea-cfg-allowBlank\" class=\"docClass\">allowBlank</a></strong> validation fails (defaults to 'This field is required')</p>\n"
      },
      {
        "static": false,
        "type": "Number/String",
      ...
      },
      {
        ...
        "doc": "<p>Defines a timeout in milliseconds for buffering <a href=\"#/api/Ext.form.field.TextArea-cfg-checkChangeEvents\" rel=\"Ext.form.field.TextArea-cfg-checkChangeEvents\" class=\"docClass\">checkChangeEvents</a> that fire in rapid succession.\nDefaults to 50 milliseconds.</p>\n"
      },
      {
        "static": false,
        "type": "String[]",
      ...
      },
      {
        ...
        "properties": null,
        "linenr": 78,
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-cols",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        "alias": null,
        "name": "cols",
        "shortDoc": "An initial value for the 'cols' attribute on the textarea element. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>An initial value for the 'cols' attribute on the textarea element. This is only used if the component has no\nconfigured <a href=\"#/api/Ext.form.field.TextArea-cfg-width\" rel=\"Ext.form.field.TextArea-cfg-width\" class=\"docClass\">width</a> and is not given a width by its container's layout. Defaults to 4.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "name": "data",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>The initial set of data to apply to the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-tpl\" rel=\"Ext.form.field.TextArea-cfg-tpl\" class=\"docClass\">tpl</a></code> to\nupdate the content area of the Component.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "name": "dirtyCls",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>The CSS class to use when the field value <a href=\"#/api/Ext.form.field.TextArea-method-isDirty\" rel=\"Ext.form.field.TextArea-method-isDirty\" class=\"docClass\">is dirty</a>.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>The CSS class to apply to an empty field to style the <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-emptyText\" rel=\"Ext.form.field.TextArea-cfg-emptyText\" class=\"docClass\">emptyText</a></strong> (defaults to 'x-form-empty-field').\nThis class is automatically added and removed as needed depending on the current field value.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-enterIsSpecial",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>An extra CSS class to be applied to the body content element in addition to <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldBodyCls\" rel=\"Ext.form.field.TextArea-cfg-fieldBodyCls\" class=\"docClass\">fieldBodyCls</a>.\nDefaults to empty.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The label for the field. It gets appended with the <a href=\"#/api/Ext.form.field.TextArea-cfg-labelSeparator\" rel=\"Ext.form.field.TextArea-cfg-labelSeparator\" class=\"docClass\">labelSeparator</a>, and its position\nand sizing is determined by the <a href=\"#/api/Ext.form.field.TextArea-cfg-labelAlign\" rel=\"Ext.form.field.TextArea-cfg-labelAlign\" class=\"docClass\">labelAlign</a>, <a href=\"#/api/Ext.form.field.TextArea-cfg-labelWidth\" rel=\"Ext.form.field.TextArea-cfg-labelWidth\" class=\"docClass\">labelWidth</a>, and <a href=\"#/api/Ext.form.field.TextArea-cfg-labelPad\" rel=\"Ext.form.field.TextArea-cfg-labelPad\" class=\"docClass\">labelPad</a>\nconfigs. Defaults to undefined.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Optional CSS style(s) to be applied to the <a href=\"#/api/Ext.form.field.TextArea-property-inputEl\" rel=\"Ext.form.field.TextArea-property-inputEl\" class=\"docClass\">field input element</a>. Should be a valid argument to\n<a href=\"#/api/Ext.Element-method-applyStyles\" rel=\"Ext.Element-method-applyStyles\" class=\"docClass\">Ext.Element.applyStyles</a>. Defaults to undefined. See also the <a href=\"#/api/Ext.form.field.TextArea-method-setFieldStyle\" rel=\"Ext.form.field.TextArea-method-setFieldStyle\" class=\"docClass\">setFieldStyle</a> method for changing\nthe style after initialization.</p>\n"
      },
      {
        "static": false,
        "type": "Ext.XTemplate",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Specify as true to float the Component outside of the document flow using CSS absolute positioning.</p>\n\n\n<p>Components such as <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a>s and <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a>s are floating\nby default.</p>\n\n\n<p>Floating Components that are programatically <a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a> will register themselves with the global\n<a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a></p>\n\n\n<h3 class=\"pa\">Floating Components as child items of a Container</h3>\n\n\n<p>A floating Component may be used as a child item of a Container. This just allows the floating Component to seek a ZIndexManager by\nexamining the ownerCt chain.</p>\n\n\n<p>When configured as floating, Components acquire, at render time, a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> which manages a stack\nof related floating Components. The ZIndexManager brings a single floating Component to the top of its stack when\nthe Component's <a href=\"#/api/Ext.form.field.TextArea-method-toFront\" rel=\"Ext.form.field.TextArea-method-toFront\" class=\"docClass\">toFront</a> method is called.</p>\n\n\n<p>The ZIndexManager is found by traversing up the <a href=\"#/api/Ext.form.field.TextArea-property-ownerCt\" rel=\"Ext.form.field.TextArea-property-ownerCt\" class=\"docClass\">ownerCt</a> chain to find an ancestor which itself is floating. This is so that\ndescendant floating Components of floating <i>Containers</i> (Such as a ComboBox dropdown within a Window) can have its zIndex managed relative\nto any siblings, but always <b>above</b> that floating ancestor Container.</p>\n\n\n<p>If no floating ancestor is found, a floating Component registers itself with the default <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a>.</p>\n\n\n<p>Floating components <i>do not participate in the Container's layout</i>. Because of this, they are not rendered until you explicitly\n<a href=\"#/api/Ext.form.field.TextArea-method-show\" rel=\"Ext.form.field.TextArea-method-show\" class=\"docClass\">show</a> them.</p>\n\n\n<p>After rendering, the ownerCt reference is deleted, and the <a href=\"#/api/Ext.form.field.TextArea-property-floatParent\" rel=\"Ext.form.field.TextArea-property-floatParent\" class=\"docClass\">floatParent</a> property is set to the found floating ancestor Container.\nIf no floating ancestor Container was found the <a href=\"#/api/Ext.form.field.TextArea-property-floatParent\" rel=\"Ext.form.field.TextArea-property-floatParent\" class=\"docClass\">floatParent</a> property will not be set.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-growAppend",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>A string that will be appended to the field's current value for the purposes of calculating the target field\nsize. Only used when the <a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a> config is true. Defaults to a newline for TextArea to ensure there is\nalways a space below the current line.</p>\n"
      },
      {
        "static": false,
        "type": "Number",
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-growMax",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        ...
        "name": "growMax",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>The maximum height to allow when <a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a>=true (defaults to 1000)</p>\n"
      },
      {
        "static": false,
        "type": "Number",
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-growMin",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        ...
        "name": "growMin",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>The minimum height to allow when <a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a>=true (defaults to 60)</p>\n"
      },
      {
        "static": false,
        "type": "Number",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>When set to <tt>true</tt>, the label element (<a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> and <a href=\"#/api/Ext.form.field.TextArea-cfg-labelSeparator\" rel=\"Ext.form.field.TextArea-cfg-labelSeparator\" class=\"docClass\">labelSeparator</a>) will be\nautomatically hidden if the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> is empty. Setting this to <tt>false</tt> will cause the empty\nlabel element to be rendered and space to be reserved for it; this is useful if you want a field without a label\nto line up with other labeled fields in the same form. Defaults to <tt>true</tt>.</p>\n\n\n<p>If you wish to unconditionall hide the label even if a non-empty fieldLabel is configured, then set\nthe <a href=\"#/api/Ext.form.field.TextArea-cfg-hideLabel\" rel=\"Ext.form.field.TextArea-cfg-hideLabel\" class=\"docClass\">hideLabel</a> config to <tt>true</tt>.</p>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Set to <tt>true</tt> to completely hide the label element (<a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> and <a href=\"#/api/Ext.form.field.TextArea-cfg-labelSeparator\" rel=\"Ext.form.field.TextArea-cfg-labelSeparator\" class=\"docClass\">labelSeparator</a>).\nDefaults to <tt>false</tt>.</p>\n\n\n<p>Also see <a href=\"#/api/Ext.form.field.TextArea-cfg-hideEmptyLabel\" rel=\"Ext.form.field.TextArea-cfg-hideEmptyLabel\" class=\"docClass\">hideEmptyLabel</a>, which controls whether space will be reserved for an empty fieldLabel.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>An HTML fragment, or a <a href=\"#/api/Ext.DomHelper\" rel=\"Ext.DomHelper\" class=\"docClass\">DomHelper</a> specification to use as the layout element\ncontent (defaults to ''). The HTML content is added after the component is rendered,\nso the document will not contain this HTML at the time the <a href=\"#/api/Ext.form.field.TextArea-event-render\" rel=\"Ext.form.field.TextArea-event-render\" class=\"docClass\">render</a> event is fired.\nThis content is inserted into the body <i>before</i> any configured <a href=\"#/api/Ext.form.field.TextArea-cfg-contentEl\" rel=\"Ext.form.field.TextArea-cfg-contentEl\" class=\"docClass\">contentEl</a> is appended.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>The <b><u>unique id of this component instance</u></b> (defaults to an <a href=\"#/api/Ext.form.field.TextArea-method-getId\" rel=\"Ext.form.field.TextArea-method-getId\" class=\"docClass\">auto-assigned id</a>).</p>\n\n\n<p>It should not be necessary to use this configuration except for singleton objects in your application.\nComponents created with an id may be accessed globally using <a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">Ext.getCmp</a>.</p>\n\n\n<p>Instead of using assigned ids, use the <a href=\"#/api/Ext.form.field.TextArea-cfg-itemId\" rel=\"Ext.form.field.TextArea-cfg-itemId\" class=\"docClass\">itemId</a> config, and <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> which\nprovides selector-based searching for Sencha Components analogous to DOM querying. The <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Container</a>\nclass contains <a href=\"#/api/Ext.container.Container-method-down\" rel=\"Ext.container.Container-method-down\" class=\"docClass\">shortcut methods</a> to query its descendant Components by selector.</p>\n\n\n<p>Note that this id will also be used as the element id for the containing HTML element\nthat is rendered to the page for this component. This allows you to write id-based CSS\nrules to style the specific instance of this component uniquely, and also to select\nsub-elements using this component's id as the parent.</p>\n\n\n<p><b>Note</b>: to avoid complications imposed by a unique <tt>id</tt> also see <code><a href=\"#/api/Ext.form.field.TextArea-cfg-itemId\" rel=\"Ext.form.field.TextArea-cfg-itemId\" class=\"docClass\">itemId</a></code>.</p>\n\n\n<p><b>Note</b>: to access the container of a Component see <code><a href=\"#/api/Ext.form.field.TextArea-property-ownerCt\" rel=\"Ext.form.field.TextArea-property-ownerCt\" class=\"docClass\">ownerCt</a></code>.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>An <tt>itemId</tt> can be used as an alternative way to get a reference to a component\nwhen no object reference is available.  Instead of using an <code><a href=\"#/api/Ext.form.field.TextArea-cfg-id\" rel=\"Ext.form.field.TextArea-cfg-id\" class=\"docClass\">id</a></code> with\n<a href=\"#/api/Ext\" rel=\"Ext\" class=\"docClass\">Ext</a>.<a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">getCmp</a>, use <code>itemId</code> with\n<a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Ext.container.Container</a>.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a> which will retrieve\n<code>itemId</code>'s or <tt><a href=\"#/api/Ext.form.field.TextArea-cfg-id\" rel=\"Ext.form.field.TextArea-cfg-id\" class=\"docClass\">id</a></tt>'s. Since <code>itemId</code>'s are an index to the\ncontainer's internal MixedCollection, the <code>itemId</code> is scoped locally to the container --\navoiding potential conflicts with <a href=\"#/api/Ext.ComponentManager\" rel=\"Ext.ComponentManager\" class=\"docClass\">Ext.ComponentManager</a> which requires a <b>unique</b>\n<code><a href=\"#/api/Ext.form.field.TextArea-cfg-id\" rel=\"Ext.form.field.TextArea-cfg-id\" class=\"docClass\">id</a></code>.</p>\n\n\n<pre><code>var c = new Ext.panel.Panel({ //\n    <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 300,\n    <a href=\"#/api/Ext.form.field.TextArea-cfg-renderTo\" rel=\"Ext.form.field.TextArea-cfg-renderTo\" class=\"docClass\">renderTo</a>: document.body,\n    <a href=\"#/api/Ext.container.Container-cfg-layout\" rel=\"Ext.container.Container-cfg-layout\" class=\"docClass\">layout</a>: 'auto',\n    <a href=\"#/api/Ext.container.Container-property-items\" rel=\"Ext.container.Container-property-items\" class=\"docClass\">items</a>: [\n        {\n            itemId: 'p1',\n            <a href=\"#/api/Ext.panel.Panel-cfg-title\" rel=\"Ext.panel.Panel-cfg-title\" class=\"docClass\">title</a>: 'Panel 1',\n            <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 150\n        },\n        {\n            itemId: 'p2',\n            <a href=\"#/api/Ext.panel.Panel-cfg-title\" rel=\"Ext.panel.Panel-cfg-title\" class=\"docClass\">title</a>: 'Panel 2',\n            <a href=\"#/api/Ext.Component-cfg-height\" rel=\"Ext.Component-cfg-height\" class=\"docClass\">height</a>: 150\n        }\n    ]\n})\np1 = c.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a>('p1'); // not the same as <a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">Ext.getCmp()</a>\np2 = p1.<a href=\"#/api/Ext.form.field.TextArea-property-ownerCt\" rel=\"Ext.form.field.TextArea-property-ownerCt\" class=\"docClass\">ownerCt</a>.<a href=\"#/api/Ext.container.Container-method-getComponent\" rel=\"Ext.container.Container-method-getComponent\" class=\"docClass\">getComponent</a>('p2'); // reference via a sibling\n</code></pre>\n\n\n<p>Also see <tt><a href=\"#/api/Ext.form.field.TextArea-cfg-id\" rel=\"Ext.form.field.TextArea-cfg-id\" class=\"docClass\">id</a></tt>, <code><a href=\"#/api/Ext.container.Container-method-query\" rel=\"Ext.container.Container-method-query\" class=\"docClass\">Ext.container.Container.query</a></code>,\n<code><a href=\"#/api/Ext.container.Container-method-down\" rel=\"Ext.container.Container-method-down\" class=\"docClass\">Ext.container.Container.down</a></code> and <code><a href=\"#/api/Ext.container.Container-method-child\" rel=\"Ext.container.Container-method-child\" class=\"docClass\">Ext.container.Container.child</a></code>.</p>\n\n\n<p><b>Note</b>: to access the container of an item see <tt><a href=\"#/api/Ext.form.field.TextArea-property-ownerCt\" rel=\"Ext.form.field.TextArea-property-ownerCt\" class=\"docClass\">ownerCt</a></tt>.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Controls the position and alignment of the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a>. Valid values are:</p>\n\n\n<ul>\n<li><tt>\"left\"</tt> (the default) - The label is positioned to the left of the field, with its text\naligned to the left. Its width is determined by the <a href=\"#/api/Ext.form.field.TextArea-cfg-labelWidth\" rel=\"Ext.form.field.TextArea-cfg-labelWidth\" class=\"docClass\">labelWidth</a> config.</li>\n<li><tt>\"top\"</tt> - The label is positioned above the field.</li>\n<li><tt>\"right\"</tt> - The label is positioned to the left of the field, with its text aligned\nto the right. Its width is determined by the <a href=\"#/api/Ext.form.field.TextArea-cfg-labelWidth\" rel=\"Ext.form.field.TextArea-cfg-labelWidth\" class=\"docClass\">labelWidth</a> config.</li>\n</ul>\n\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The CSS class to be applied to the label element. Defaults to 'x-form-item-label'.\nThis (single) CSS class is used to formulate the renderSelector and drives the field\nlayout where it is concatenated with a hyphen ('-') and <a href=\"#/api/Ext.form.field.TextArea-cfg-labelAlign\" rel=\"Ext.form.field.TextArea-cfg-labelAlign\" class=\"docClass\">labelAlign</a>. To add\nadditional classes, use <a href=\"#/api/Ext.form.field.TextArea-cfg-labelClsExtra\" rel=\"Ext.form.field.TextArea-cfg-labelClsExtra\" class=\"docClass\">labelClsExtra</a>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The amount of space in pixels between the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> and the input field. Defaults to <tt>5</tt>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "name": "labelSeparator",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Character(s) to be inserted at the end of the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">label text</a>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The width of the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> in pixels. Only applicable if the <a href=\"#/api/Ext.form.field.TextArea-cfg-labelAlign\" rel=\"Ext.form.field.TextArea-cfg-labelAlign\" class=\"docClass\">labelAlign</a> is set\nto \"left\" or \"right\". Defaults to <tt>100</tt>.</p>\n"
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "doc": "<p>A config object containing one or more event handlers to be added to this object during initialization. This\nshould be a valid listeners config object as specified in the <a href=\"#/api/Ext.form.field.TextArea-method-addListener\" rel=\"Ext.form.field.TextArea-method-addListener\" class=\"docClass\">addListener</a> example for attaching multiple\nhandlers at once.</p>\n\n<p><strong>DOM events from ExtJS <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Components</a></strong></p>\n\n<p>While <em>some</em> ExtJs Component classes export selected DOM events (e.g. \"click\", \"mouseover\" etc), this is usually\nonly done when extra value can be added. For example the <a href=\"#/api/Ext.view.View\" rel=\"Ext.view.View\" class=\"docClass\">DataView</a>'s <strong><code><a href=\"#/api/Ext.view.View-event-itemclick\" rel=\"Ext.view.View-event-itemclick\" class=\"docClass\">itemclick</a></code></strong> event passing the node clicked on. To access DOM events directly from a\nchild element of a Component, we need to specify the <code>element</code> option to identify the Component property to add a\nDOM listener to:</p>\n\n<pre><code>new Ext.panel.Panel({\n    width: 400,\n    height: 200,\n    dockedItems: [{\n        xtype: 'toolbar'\n    }],\n    listeners: {\n        click: {\n            element: 'el', //bind to the underlying el property on the panel\n            fn: function(){ console.log('click el'); }\n        },\n        dblclick: {\n            element: 'body', //bind to the underlying body property on the panel\n            fn: function(){ console.log('dblclick body'); }\n        }\n    }\n});\n</code></pre>\n"
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Error text to display if the <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-maxLength\" rel=\"Ext.form.field.TextArea-cfg-maxLength\" class=\"docClass\">maximum length</a></strong> validation fails (defaults to 'The maximum\nlength for this field is {maxLength}')</p>\n"
      },
      {
        "static": false,
        "type": "Number",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Error text to display if the <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-minLength\" rel=\"Ext.form.field.TextArea-cfg-minLength\" class=\"docClass\">minimum length</a></strong> validation fails (defaults to 'The minimum\nlength for this field is {minLength}')</p>\n"
      },
      {
        "static": false,
        "type": "Number",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>The name of the field (defaults to undefined). This is used as the parameter name when including the field value\nin a <a href=\"#/api/Ext.form.Basic-method-submit\" rel=\"Ext.form.Basic-method-submit\" class=\"docClass\">form submit()</a>. If no name is configured, it falls back to the <a href=\"#/api/Ext.form.field.TextArea-cfg-inputId\" rel=\"Ext.form.field.TextArea-cfg-inputId\" class=\"docClass\">inputId</a>.\nTo prevent the field from being included in the form submit, set <a href=\"#/api/Ext.form.field.TextArea-cfg-submitValue\" rel=\"Ext.form.field.TextArea-cfg-submitValue\" class=\"docClass\">submitValue</a> to false.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p><tt>true</tt> to disable displaying any <a href=\"#/api/Ext.form.field.TextArea-method-setActiveError\" rel=\"Ext.form.field.TextArea-method-setActiveError\" class=\"docClass\">error message</a> set on this object.\nDefaults to <tt>false</tt>.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-cfg-preventScrollbars",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        ...
        "shortDoc": "true to prevent scrollbars from appearing regardless of how much text is in the field. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>true to prevent scrollbars from appearing regardless of how much text is in the field. This option is only\nrelevant when <a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a> is true. Equivalent to setting overflow: hidden, defaults to false.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "name": "readOnlyCls",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>The CSS class applied to the component's main element when it is <a href=\"#/api/Ext.form.field.TextArea-cfg-readOnly\" rel=\"Ext.form.field.TextArea-cfg-readOnly\" class=\"docClass\">readOnly</a>.</p>\n"
      },
      {
        "static": false,
        "type": "RegExp",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>A JavaScript RegExp object to be tested against the field value during validation (defaults to undefined). If the\ntest fails, the field will be marked invalid using <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-regexText\" rel=\"Ext.form.field.TextArea-cfg-regexText\" class=\"docClass\">regexText</a></strong>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "name": "regexText",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>The error text to display if <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-regex\" rel=\"Ext.form.field.TextArea-cfg-regex\" class=\"docClass\">regex</a></strong> is used and the test fails during validation (defaults to '')</p>\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "name": "selectOnFocus",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>true to automatically select any existing field text when the field receives input focus (defaults to false)</p>\n"
      },
      {
        "static": false,
        "type": "String/Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>An initial value for the 'size' attribute on the text input element. This is only used if the field has no\nconfigured <a href=\"#/api/Ext.form.field.TextArea-cfg-width\" rel=\"Ext.form.field.TextArea-cfg-width\" class=\"docClass\">width</a> and is not given a width by its container's layout. Defaults to 20.</p>\n"
      },
      {
        "static": false,
        "type": "String[]",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>An array of events that, when fired, should trigger this object to\nsave its state (defaults to none). <code>stateEvents</code> may be any type\nof event supported by this object, including browser or custom events\n(e.g., <tt>['click', 'customerchange']</tt>).</p>\n\n\n<p>See <code><a href=\"#/api/Ext.form.field.TextArea-cfg-stateful\" rel=\"Ext.form.field.TextArea-cfg-stateful\" class=\"docClass\">stateful</a></code> for an explanation of saving and\nrestoring object state.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>The unique id for this object to use for state management purposes.</p>\n\n<p>See <a href=\"#/api/Ext.form.field.TextArea-cfg-stateful\" rel=\"Ext.form.field.TextArea-cfg-stateful\" class=\"docClass\">stateful</a> for an explanation of saving and restoring state.</p>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>A flag which causes the object to attempt to restore the state of\ninternal properties from a saved state on startup. The object must have\na <code><a href=\"#/api/Ext.form.field.TextArea-cfg-stateId\" rel=\"Ext.form.field.TextArea-cfg-stateId\" class=\"docClass\">stateId</a></code> for state to be managed.\nAuto-generated ids are not guaranteed to be stable across page loads and\ncannot be relied upon to save and restore the same state for a object.<p>\n<p>For state saving to work, the state manager's provider must have been\nset to an implementation of <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> which overrides the\n<a href=\"#/api/Ext.state.Provider-method-set\" rel=\"Ext.state.Provider-method-set\" class=\"docClass\">set</a> and <a href=\"#/api/Ext.state.Provider-method-get\" rel=\"Ext.state.Provider-method-get\" class=\"docClass\">get</a>\nmethods to save and recall name/value pairs. A built-in implementation,\n<a href=\"#/api/Ext.state.CookieProvider\" rel=\"Ext.state.CookieProvider\" class=\"docClass\">Ext.state.CookieProvider</a> is available.</p>\n<p>To set the state provider for the current page:</p>\n<pre><code>Ext.state.Manager.setProvider(new Ext.state.CookieProvider({\n    expires: new Date(new Date().getTime()+(1000*60*60*24*7)), //7 days from now\n}));\n</code></pre>\n<p>A stateful object attempts to save state when one of the events\nlisted in the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-stateEvents\" rel=\"Ext.form.field.TextArea-cfg-stateEvents\" class=\"docClass\">stateEvents</a></code> configuration fires.</p>\n<p>To save state, a stateful object first serializes its state by\ncalling <b><code><a href=\"#/api/Ext.form.field.TextArea-method-getState\" rel=\"Ext.form.field.TextArea-method-getState\" class=\"docClass\">getState</a></code></b>. By default, this function does\nnothing. The developer must provide an implementation which returns an\nobject hash which represents the restorable state of the object.</p>\n<p>The value yielded by getState is passed to <a href=\"#/api/Ext.state.Manager-method-set\" rel=\"Ext.state.Manager-method-set\" class=\"docClass\">Ext.state.Manager.set</a>\nwhich uses the configured <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> to save the object\nkeyed by the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-stateId\" rel=\"Ext.form.field.TextArea-cfg-stateId\" class=\"docClass\">stateId</a></code></p>.\n<p>During construction, a stateful object attempts to <i>restore</i>\nits state by calling <a href=\"#/api/Ext.state.Manager-method-get\" rel=\"Ext.state.Manager-method-get\" class=\"docClass\">Ext.state.Manager.get</a> passing the\n<code><a href=\"#/api/Ext.form.field.TextArea-cfg-stateId\" rel=\"Ext.form.field.TextArea-cfg-stateId\" class=\"docClass\">stateId</a></code></p>\n<p>The resulting object is passed to <b><code><a href=\"#/api/Ext.form.field.TextArea-method-applyState\" rel=\"Ext.form.field.TextArea-method-applyState\" class=\"docClass\">applyState</a></code></b>.\nThe default implementation of <code><a href=\"#/api/Ext.form.field.TextArea-method-applyState\" rel=\"Ext.form.field.TextArea-method-applyState\" class=\"docClass\">applyState</a></code> simply copies\nproperties into the object, but a developer may override this to support\nmore behaviour.</p>\n<p>You can perform extra processing on state save and restore by attaching\nhandlers to the <a href=\"#/api/Ext.form.field.TextArea-event-beforestaterestore\" rel=\"Ext.form.field.TextArea-event-beforestaterestore\" class=\"docClass\">beforestaterestore</a>, <a href=\"#/api/Ext.form.field.TextArea-event-staterestore\" rel=\"Ext.form.field.TextArea-event-staterestore\" class=\"docClass\">staterestore</a>,\n<a href=\"#/api/Ext.form.field.TextArea-event-beforestatesave\" rel=\"Ext.form.field.TextArea-event-beforestatesave\" class=\"docClass\">beforestatesave</a> and <a href=\"#/api/Ext.form.field.TextArea-event-statesave\" rel=\"Ext.form.field.TextArea-event-statesave\" class=\"docClass\">statesave</a> events.</p>\n\n"
      },
      {
        "static": false,
        "type": "RegExp",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.form.field.TextArea-method-toFront\" rel=\"Ext.form.field.TextArea-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.form.field.TextArea-method-show\" rel=\"Ext.form.field.TextArea-method-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n"
      },
      {
        "static": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>An <bold><a href=\"#/api/Ext.Template\" rel=\"Ext.Template\" class=\"docClass\">Ext.Template</a></bold>, <bold><a href=\"#/api/Ext.XTemplate\" rel=\"Ext.XTemplate\" class=\"docClass\">Ext.XTemplate</a></bold>\nor an array of strings to form an <a href=\"#/api/Ext.XTemplate\" rel=\"Ext.XTemplate\" class=\"docClass\">Ext.XTemplate</a>.\nUsed in conjunction with the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-data\" rel=\"Ext.form.field.TextArea-cfg-data\" class=\"docClass\">data</a></code> and\n<code><a href=\"#/api/Ext.form.field.TextArea-cfg-tplWriteMode\" rel=\"Ext.form.field.TextArea-cfg-tplWriteMode\" class=\"docClass\">tplWriteMode</a></code> configurations.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>A custom validation function to be called during field validation (<a href=\"#/api/Ext.form.field.TextArea-method-getErrors\" rel=\"Ext.form.field.TextArea-method-getErrors\" class=\"docClass\">getErrors</a>) (defaults to undefined).\nIf specified, this function will be called first, allowing the developer to override the default validation\nprocess.</p>\n\n<p>This function will be passed the following parameters:</p>\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>A custom error message to display in place of the default message provided for the <strong><code><a href=\"#/api/Ext.form.field.TextArea-cfg-vtype\" rel=\"Ext.form.field.TextArea-cfg-vtype\" class=\"docClass\">vtype</a></code></strong> currently\nset for this field (defaults to undefined). <strong>Note</strong>: only applies if <strong><code><a href=\"#/api/Ext.form.field.TextArea-cfg-vtype\" rel=\"Ext.form.field.TextArea-cfg-vtype\" class=\"docClass\">vtype</a></code></strong> is set, else ignored.</p>\n"
      },
      {
        "static": false,
        "type": "Number",
    ...
    "event": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component rendering is finished.</p>\n\n\n<p>The afterrender event is fired after this Component has been <a href=\"#/api/Ext.form.field.TextArea-property-rendered\" rel=\"Ext.form.field.TextArea-property-rendered\" class=\"docClass\">rendered</a>, been postprocesed\nby any afterRender method defined for the Component.</p>\n\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Fires when the <strong><a href=\"#/api/Ext.form.field.TextArea-method-autoSize\" rel=\"Ext.form.field.TextArea-method-autoSize\" class=\"docClass\">autoSize</a></strong> function is triggered and the field is resized according to the\n<a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a>/<a href=\"#/api/Ext.form.field.TextArea-cfg-growMin\" rel=\"Ext.form.field.TextArea-cfg-growMin\" class=\"docClass\">growMin</a>/<a href=\"#/api/Ext.form.field.TextArea-cfg-growMax\" rel=\"Ext.form.field.TextArea-cfg-growMax\" class=\"docClass\">growMax</a> configs as a result. This event provides a hook for the\ndeveloper to apply additional logic at runtime to resize the field if needed.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.form.field.TextArea-method-destroy\" rel=\"Ext.form.field.TextArea-method-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.form.field.TextArea-method-destroy\" rel=\"Ext.form.field.TextArea-method-destroy\" class=\"docClass\">destroy</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.form.field.TextArea-method-hide\" rel=\"Ext.form.field.TextArea-method-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.form.field.TextArea-property-rendered\" rel=\"Ext.form.field.TextArea-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.form.field.TextArea-event-render\" rel=\"Ext.form.field.TextArea-event-render\" class=\"docClass\">render</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.form.field.TextArea-method-show\" rel=\"Ext.form.field.TextArea-method-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.form.field.TextArea-method-destroy\" rel=\"Ext.form.field.TextArea-method-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Fires when a change in the field's <a href=\"#/api/Ext.form.field.TextArea-method-isDirty\" rel=\"Ext.form.field.TextArea-method-isDirty\" class=\"docClass\">isDirty</a> state is detected.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Fires when the active error message is changed via <a href=\"#/api/Ext.form.field.TextArea-method-setActiveError\" rel=\"Ext.form.field.TextArea-method-setActiveError\" class=\"docClass\">setActiveError</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.form.field.TextArea-method-hide\" rel=\"Ext.form.field.TextArea-method-hide\" class=\"docClass\">hide</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Keydown input field event. This event only fires if <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-enableKeyEvents\" rel=\"Ext.form.field.TextArea-cfg-enableKeyEvents\" class=\"docClass\">enableKeyEvents</a></strong> is set to true.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Keypress input field event. This event only fires if <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-enableKeyEvents\" rel=\"Ext.form.field.TextArea-cfg-enableKeyEvents\" class=\"docClass\">enableKeyEvents</a></strong> is set to true.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Keyup input field event. This event only fires if <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-enableKeyEvents\" rel=\"Ext.form.field.TextArea-cfg-enableKeyEvents\" class=\"docClass\">enableKeyEvents</a></strong> is set to true.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component markup is <a href=\"#/api/Ext.form.field.TextArea-property-rendered\" rel=\"Ext.form.field.TextArea-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.form.field.TextArea-method-show\" rel=\"Ext.form.field.TextArea-method-show\" class=\"docClass\">show</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
    ...
    "method": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Adds each argument passed to this method to the <a href=\"#/api/Ext.form.field.TextArea-cfg-childEls\" rel=\"Ext.form.field.TextArea-cfg-childEls\" class=\"docClass\">childEls</a> array.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.form.field.TextArea-method-addUIClsToElement\" rel=\"Ext.form.field.TextArea-method-addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The method the event invokes.  Will be called with arguments given to\n<a href=\"#/api/Ext.form.field.TextArea-method-fireEvent\" rel=\"Ext.form.field.TextArea-method-fireEvent\" class=\"docClass\">fireEvent</a> plus the <code>options</code> parameter described below.</p>\n"
          },
          {
            "type": "Object",
            "properties": [
      ...
      },
      {
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-method-autoSize",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "autoSize",
        "shortDoc": "Automatically grows the field to accomodate the height of the text up to the maximum field height allowed. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>Automatically grows the field to accomodate the height of the text up to the maximum field height allowed. This\nonly takes effect if <a href=\"#/api/Ext.form.field.TextArea-cfg-grow\" rel=\"Ext.form.field.TextArea-cfg-grow\" class=\"docClass\">grow</a> = true, and fires the <a href=\"#/api/Ext.form.field.TextArea-event-autosize\" rel=\"Ext.form.field.TextArea-event-autosize\" class=\"docClass\">autosize</a> event if the height changes.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Checks whether the value of the field has changed since the last time it was checked.\nIf the value has changed, it:</p>\n\n<ol>\n<li>Fires the <a href=\"#/api/Ext.form.field.TextArea-event-change\" rel=\"Ext.form.field.TextArea-event-change\" class=\"docClass\">change event</a>,</li>\n<li>Performs validation if the <a href=\"#/api/Ext.form.field.TextArea-cfg-validateOnChange\" rel=\"Ext.form.field.TextArea-cfg-validateOnChange\" class=\"docClass\">validateOnChange</a> config is enabled, firing the\n<a href=\"#/api/Ext.form.field.TextArea-event-validitychange\" rel=\"Ext.form.field.TextArea-event-validitychange\" class=\"docClass\">validitychange event</a> if the validity has changed, and</li>\n<li>Checks the <a href=\"#/api/Ext.form.field.TextArea-method-isDirty\" rel=\"Ext.form.field.TextArea-method-isDirty\" class=\"docClass\">dirty state</a> of the field and fires the <a href=\"#/api/Ext.form.field.TextArea-event-dirtychange\" rel=\"Ext.form.field.TextArea-event-dirtychange\" class=\"docClass\">dirtychange event</a>\nif it has changed.</li>\n</ol>\n\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Checks the <a href=\"#/api/Ext.form.field.TextArea-method-isDirty\" rel=\"Ext.form.field.TextArea-method-isDirty\" class=\"docClass\">isDirty</a> state of the field and if it has changed since the last time it was checked,\nfires the <a href=\"#/api/Ext.form.field.TextArea-event-dirtychange\" rel=\"Ext.form.field.TextArea-event-dirtychange\" class=\"docClass\">dirtychange</a> event.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Only relevant if the instance's <a href=\"#/api/Ext.form.field.TextArea-method-isFileUpload\" rel=\"Ext.form.field.TextArea-method-isFileUpload\" class=\"docClass\">isFileUpload</a> method returns true. Returns a reference to the file input\nDOM element holding the user's selected file. The input will be appended into the submission form and will not be\nreturned, so this method should also create a replacement.</p>\n",
        "return": {
          "type": "HTMLElement",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Fires the specified event with the passed parameters (minus the event name, plus the <code>options</code> object passed\nto <a href=\"#/api/Ext.form.field.TextArea-method-addListener\" rel=\"Ext.form.field.TextArea-method-addListener\" class=\"docClass\">addListener</a>).</p>\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>) by\ncalling <a href=\"#/api/Ext.form.field.TextArea-method-enableBubble\" rel=\"Ext.form.field.TextArea-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "owner": "Ext.form.field.TextArea",
        "html_filename": "TextArea.html",
        "href": "TextArea.html#Ext-form-field-TextArea-method-getBodyNaturalWidth",
        "protected": true,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "shortDoc": "To get the natural width of the textarea element, we do a simple calculation based on the 'cols' config. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/TextArea.js",
        "doc": "<p>To get the natural width of the textarea element, we do a simple calculation based on the 'cols' config.\nWe use hard-coded numbers to approximate what browsers do natively, to avoid having to read any styles which\nwould hurt performance. Overrides Labelable method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Validates a value according to the field's validation rules and returns an array of errors\nfor any failing validations. Validation rules are processed in the following order:</p>\n\n<ol>\n<li><p><strong>Field specific validator</strong></p>\n\n<p> A validator offers a way to customize and reuse a validation specification.\n If a field is configured with a <code><a href=\"#/api/Ext.form.field.TextArea-cfg-validator\" rel=\"Ext.form.field.TextArea-cfg-validator\" class=\"docClass\">validator</a></code>\n function, it will be passed the current field value.  The <code><a href=\"#/api/Ext.form.field.TextArea-cfg-validator\" rel=\"Ext.form.field.TextArea-cfg-validator\" class=\"docClass\">validator</a></code>\n function is expected to return either:</p>\n\n<ul>\n<li>Boolean <code>true</code>  if the value is valid (validation continues).</li>\n<li>a String to represent the invalid message if invalid (validation halts).</li>\n</ul>\n</li>\n<li><p><strong>Basic Validation</strong></p>\n\n<p> If the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-validator\" rel=\"Ext.form.field.TextArea-cfg-validator\" class=\"docClass\">validator</a></code> has not halted validation,\n basic validation proceeds as follows:</p>\n\n<ul>\n<li><p><code><a href=\"#/api/Ext.form.field.TextArea-cfg-allowBlank\" rel=\"Ext.form.field.TextArea-cfg-allowBlank\" class=\"docClass\">allowBlank</a></code> : (Invalid message = <code><a href=\"#/api/Ext.form.field.TextArea-cfg-emptyText\" rel=\"Ext.form.field.TextArea-cfg-emptyText\" class=\"docClass\">emptyText</a></code>)</p>\n\n<p>  Depending on the configuration of <code><a href=\"#/api/Ext.form.field.TextArea-cfg-allowBlank\" rel=\"Ext.form.field.TextArea-cfg-allowBlank\" class=\"docClass\">allowBlank</a></code>, a\n  blank field will cause validation to halt at this step and return\n  Boolean true or false accordingly.</p></li>\n<li><p><code><a href=\"#/api/Ext.form.field.TextArea-cfg-minLength\" rel=\"Ext.form.field.TextArea-cfg-minLength\" class=\"docClass\">minLength</a></code> : (Invalid message = <code><a href=\"#/api/Ext.form.field.TextArea-cfg-minLengthText\" rel=\"Ext.form.field.TextArea-cfg-minLengthText\" class=\"docClass\">minLengthText</a></code>)</p>\n\n<p>  If the passed value does not satisfy the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-minLength\" rel=\"Ext.form.field.TextArea-cfg-minLength\" class=\"docClass\">minLength</a></code>\n  specified, validation halts.</p></li>\n<li><p><code><a href=\"#/api/Ext.form.field.TextArea-cfg-maxLength\" rel=\"Ext.form.field.TextArea-cfg-maxLength\" class=\"docClass\">maxLength</a></code> : (Invalid message = <code><a href=\"#/api/Ext.form.field.TextArea-cfg-maxLengthText\" rel=\"Ext.form.field.TextArea-cfg-maxLengthText\" class=\"docClass\">maxLengthText</a></code>)</p>\n\n<p> If the passed value does not satisfy the <code><a href=\"#/api/Ext.form.field.TextArea-cfg-maxLength\" rel=\"Ext.form.field.TextArea-cfg-maxLength\" class=\"docClass\">maxLength</a></code>\n specified, validation halts.</p></li>\n</ul>\n</li>\n<li><p><strong>Preconfigured Validation Types (VTypes)</strong></p>\n\n<p> If none of the prior validation steps halts validation, a field\n configured with a <code><a href=\"#/api/Ext.form.field.TextArea-cfg-vtype\" rel=\"Ext.form.field.TextArea-cfg-vtype\" class=\"docClass\">vtype</a></code> will utilize the\n corresponding <a href=\"#/api/Ext.form.field.VTypes\" rel=\"Ext.form.field.VTypes\" class=\"docClass\">VTypes</a> validation function.\n If invalid, either the field's <code><a href=\"#/api/Ext.form.field.TextArea-cfg-vtypeText\" rel=\"Ext.form.field.TextArea-cfg-vtypeText\" class=\"docClass\">vtypeText</a></code> or\n the VTypes vtype Text property will be used for the invalid message.\n Keystrokes on the field will be filtered according to the VTypes\n vtype Mask property.</p></li>\n<li><p><strong>Field specific regex test</strong></p>\n\n<p> If none of the prior validation steps halts validation, a field's\n configured <code><a href=\"#/api/Ext.form.field.TextArea-cfg-regex\" rel=\"Ext.form.field.TextArea-cfg-regex\" class=\"docClass\">regex</a></code> test will be processed.\n The invalid message for this test is configured with <code><a href=\"#/api/Ext.form.field.TextArea-cfg-regexText\" rel=\"Ext.form.field.TextArea-cfg-regexText\" class=\"docClass\">regexText</a></code></p></li>\n</ol>\n\n",
        "return": {
          "type": "String[]",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Returns the label for the field. Defaults to simply returning the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldLabel\" rel=\"Ext.form.field.TextArea-cfg-fieldLabel\" class=\"docClass\">fieldLabel</a> config. Can be\noverridden to provide</p>\n",
        "return": {
          "type": "String",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Returns the input id for this field. If none was specified via the <a href=\"#/api/Ext.form.field.TextArea-cfg-inputId\" rel=\"Ext.form.field.TextArea-cfg-inputId\" class=\"docClass\">inputId</a> config, then an id will be\nautomatically generated.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Generates the arguments for the field decorations <a href=\"#/api/Ext.form.field.TextArea-cfg-labelableRenderTpl\" rel=\"Ext.form.field.TextArea-cfg-labelableRenderTpl\" class=\"docClass\">rendering template</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Returns the raw String value of the field, without performing any normalization, conversion, or validation. Gets\nthe current value of the input element if the field has been rendered, ignoring the value if it is the\n<a href=\"#/api/Ext.form.field.TextArea-cfg-emptyText\" rel=\"Ext.form.field.TextArea-cfg-emptyText\" class=\"docClass\">emptyText</a>. To get a normalized and converted value see <a href=\"#/api/Ext.form.field.TextArea-method-getValue\" rel=\"Ext.form.field.TextArea-method-getValue\" class=\"docClass\">getValue</a>.</p>\n",
        "return": {
          "type": "String",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Creates and returns the data object to be used when rendering the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldSubTpl\" rel=\"Ext.form.field.TextArea-cfg-fieldSubTpl\" class=\"docClass\">fieldSubTpl</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Returns the value that would be included in a standard form submit for this field. This will be combined with the\nfield's name to form a name=value pair in the <a href=\"#/api/Ext.form.field.TextArea-method-getSubmitData\" rel=\"Ext.form.field.TextArea-method-getSubmitData\" class=\"docClass\">submitted parameters</a>. If an empty string is\nreturned then just the name= will be submitted; if null is returned then nothing will be submitted.</p>\n\n<p>Note that the value returned will have been <a href=\"#/api/Ext.form.field.TextArea-method-processRawValue\" rel=\"Ext.form.field.TextArea-method-processRawValue\" class=\"docClass\">processed</a> but may or may not have been\nsuccessfully <a href=\"#/api/Ext.form.field.TextArea-method-validate\" rel=\"Ext.form.field.TextArea-method-validate\" class=\"docClass\">validated</a>.</p>\n",
        "return": {
          "type": "String",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Returns the current data value of the field. The type of value returned is particular to the type of the\nparticular field (e.g. a Date object for <a href=\"#/api/Ext.form.field.Date\" rel=\"Ext.form.field.Date\" class=\"docClass\">Ext.form.field.Date</a>), as the result of calling <a href=\"#/api/Ext.form.field.TextArea-method-rawToValue\" rel=\"Ext.form.field.TextArea-method-rawToValue\" class=\"docClass\">rawToValue</a> on\nthe field's <a href=\"#/api/Ext.form.field.TextArea-method-processRawValue\" rel=\"Ext.form.field.TextArea-method-processRawValue\" class=\"docClass\">processed</a> String value. To return the raw String value, see <a href=\"#/api/Ext.form.field.TextArea-method-getRawValue\" rel=\"Ext.form.field.TextArea-method-getRawValue\" class=\"docClass\">getRawValue</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.form.field.TextArea-cfg-hideMode\" rel=\"Ext.form.field.TextArea-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Returns true if the value of this Field has been changed from its <a href=\"#/api/Ext.form.field.TextArea-property-originalValue\" rel=\"Ext.form.field.TextArea-property-originalValue\" class=\"docClass\">originalValue</a>.\nWill always return false if the field is disabled.</p>\n\n<p>Note that if the owning <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">form</a> was configured with\n<a href=\"#/api/Ext.form.Basic-cfg-trackResetOnLoad\" rel=\"Ext.form.Basic-cfg-trackResetOnLoad\" class=\"docClass\">trackResetOnLoad</a> then the <a href=\"#/api/Ext.form.field.TextArea-property-originalValue\" rel=\"Ext.form.field.TextArea-property-originalValue\" class=\"docClass\">originalValue</a> is updated when\nthe values are loaded by <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Ext.form.Basic</a>.<a href=\"#/api/Ext.form.Basic-method-setValues\" rel=\"Ext.form.Basic-method-setValues\" class=\"docClass\">setValues</a>.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Returns whether two field <a href=\"#/api/Ext.form.field.TextArea-method-getValue\" rel=\"Ext.form.field.TextArea-method-getValue\" class=\"docClass\">values</a> are logically equal. Field implementations may override this\nto provide custom comparison logic appropriate for the particular field's data type.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Returns whether or not the field value is currently valid by <a href=\"#/api/Ext.form.field.TextArea-method-getErrors\" rel=\"Ext.form.field.TextArea-method-getErrors\" class=\"docClass\">validating</a> the\n<a href=\"#/api/Ext.form.field.TextArea-method-processRawValue\" rel=\"Ext.form.field.TextArea-method-processRawValue\" class=\"docClass\">processed raw value</a> of the field. <strong>Note</strong>: <a href=\"#/api/Ext.form.field.TextArea-cfg-disabled\" rel=\"Ext.form.field.TextArea-cfg-disabled\" class=\"docClass\">disabled</a> fields are\nalways treated as valid.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Display one or more error messages associated with this field, using <a href=\"#/api/Ext.form.field.TextArea-cfg-msgTarget\" rel=\"Ext.form.field.TextArea-cfg-msgTarget\" class=\"docClass\">msgTarget</a> to determine how to\ndisplay the messages and applying <a href=\"#/api/Ext.form.field.TextArea-cfg-invalidCls\" rel=\"Ext.form.field.TextArea-cfg-invalidCls\" class=\"docClass\">invalidCls</a> to the field's UI element.</p>\n\n<p><strong>Note</strong>: this method does not cause the Field's <a href=\"#/api/Ext.form.field.TextArea-method-validate\" rel=\"Ext.form.field.TextArea-method-validate\" class=\"docClass\">validate</a> or <a href=\"#/api/Ext.form.field.TextArea-method-isValid\" rel=\"Ext.form.field.TextArea-method-isValid\" class=\"docClass\">isValid</a> methods to return <code>false</code>\nif the value does <em>pass</em> validation. So simply marking a Field as invalid will not prevent submission of forms\nsubmitted with the <a href=\"#/api/Ext.form.action.Submit-cfg-clientValidation\" rel=\"Ext.form.action.Submit-cfg-clientValidation\" class=\"docClass\">Ext.form.action.Submit.clientValidation</a> option set.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.field.TextArea-method-addManagedListener\" rel=\"Ext.form.field.TextArea-method-addManagedListener\" class=\"docClass\">addManagedListener</a>.</p>\n\n<p>Adds listeners to any Observable object (or Ext.Element) which are automatically removed when this Component is\ndestroyed.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.field.TextArea-method-removeManagedListener\" rel=\"Ext.form.field.TextArea-method-removeManagedListener\" class=\"docClass\">removeManagedListener</a>.</p>\n\n<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.field.TextArea-method-mon\" rel=\"Ext.form.field.TextArea-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the next node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree to attempt to find a match. Contrast with <a href=\"#/api/Ext.form.field.TextArea-method-nextSibling\" rel=\"Ext.form.field.TextArea-method-nextSibling\" class=\"docClass\">nextSibling</a>.</p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the next sibling of this Component.</p>\n\n\n<p>Optionally selects the next sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>next()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.form.field.TextArea-method-nextNode\" rel=\"Ext.form.field.TextArea-method-nextNode\" class=\"docClass\">nextNode</a></p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.field.TextArea-method-addListener\" rel=\"Ext.form.field.TextArea-method-addListener\" class=\"docClass\">addListener</a>.</p>\n\n<p>Appends an event handler to this object.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the previous node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree in reverse order to attempt to find a match. Contrast with <a href=\"#/api/Ext.form.field.TextArea-method-previousSibling\" rel=\"Ext.form.field.TextArea-method-previousSibling\" class=\"docClass\">previousSibling</a>.</p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the previous sibling of this Component.</p>\n\n\n<p>Optionally selects the previous sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>prev()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.form.field.TextArea-method-previousNode\" rel=\"Ext.form.field.TextArea-method-previousNode\" class=\"docClass\">previousNode</a></p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Performs any necessary manipulation of a raw String value to prepare it for conversion and/or\n<a href=\"#/api/Ext.form.field.TextArea-method-validate\" rel=\"Ext.form.field.TextArea-method-validate\" class=\"docClass\">validation</a>. For text fields this applies the configured <a href=\"#/api/Ext.form.field.TextArea-cfg-stripCharsRe\" rel=\"Ext.form.field.TextArea-cfg-stripCharsRe\" class=\"docClass\">stripCharsRe</a>\nto the raw value.</p>\n",
        "return": {
          "type": "String",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.form.field.TextArea-method-removeUIClsFromElement\" rel=\"Ext.form.field.TextArea-method-removeUIClsFromElement\" class=\"docClass\">removeUIClsFromElement</a> and removes\nit from all elements of this component.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The handler to remove. <strong>This must be a reference to the function passed into the\n<a href=\"#/api/Ext.form.field.TextArea-method-addListener\" rel=\"Ext.form.field.TextArea-method-addListener\" class=\"docClass\">addListener</a> call.</strong></p>\n"
          },
          {
            "type": "Object",
            "properties": [
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.form.field.TextArea-method-addListener\" rel=\"Ext.form.field.TextArea-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.field.TextArea-method-mon\" rel=\"Ext.form.field.TextArea-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Resets the current field value to the originally-loaded value and clears any validation messages.\nAlso adds <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-emptyText\" rel=\"Ext.form.field.TextArea-cfg-emptyText\" class=\"docClass\">emptyText</a></strong> and <strong><a href=\"#/api/Ext.form.field.TextArea-cfg-emptyCls\" rel=\"Ext.form.field.TextArea-cfg-emptyCls\" class=\"docClass\">emptyCls</a></strong> if the original value was blank.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Resumes firing events (see <a href=\"#/api/Ext.form.field.TextArea-method-suspendEvents\" rel=\"Ext.form.field.TextArea-method-suspendEvents\" class=\"docClass\">suspendEvents</a>).</p>\n\n<p>If events were suspended using the <code>**queueSuspended**</code> parameter, then all events fired\nduring event suspension will be sent to any listeners now.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/util/Animate.js",
        "doc": "<p>Ensures that all effects queued after sequenceFx is called on this object are\nrun in sequence.  This is the opposite of <a href=\"#/api/Ext.form.field.TextArea-method-syncFx\" rel=\"Ext.form.field.TextArea-method-syncFx\" class=\"docClass\">syncFx</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>Set the active error message to an Array of error messages. The messages are formatted into\na single message string using the <a href=\"#/api/Ext.form.field.TextArea-cfg-activeErrorsTpl\" rel=\"Ext.form.field.TextArea-cfg-activeErrorsTpl\" class=\"docClass\">activeErrorsTpl</a>. Also see <a href=\"#/api/Ext.form.field.TextArea-method-setActiveError\" rel=\"Ext.form.field.TextArea-method-setActiveError\" class=\"docClass\">setActiveError</a>\nwhich allows setting the entire error contents with a single string.</p>\n\n<p>Note that this only updates the error message element's text and attributes, you'll have\nto call doComponentLayout to actually update the field's layout to match. If the field extends\n<a href=\"#/api/Ext.form.field.Base\" rel=\"Ext.form.field.Base\" class=\"docClass\">Ext.form.field.Base</a> you should call <a href=\"#/api/Ext.form.field.Base-method-markInvalid\" rel=\"Ext.form.field.Base-method-markInvalid\" class=\"docClass\">markInvalid</a> instead.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Set the <a href=\"#/api/Ext.form.field.TextArea-cfg-fieldStyle\" rel=\"Ext.form.field.TextArea-cfg-fieldStyle\" class=\"docClass\">CSS style</a> of the <a href=\"#/api/Ext.form.field.TextArea-property-inputEl\" rel=\"Ext.form.field.TextArea-property-inputEl\" class=\"docClass\">field input element</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "height",
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.form.field.TextArea-method-getEl\" rel=\"Ext.form.field.TextArea-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n"
          }
        ],
        "alias": null,
        "name": "setHeight",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.form.field.TextArea-event-resize\" rel=\"Ext.form.field.TextArea-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Sets the page XY position of the component.  To set the left and top instead, use <a href=\"#/api/Ext.form.field.TextArea-method-setPosition\" rel=\"Ext.form.field.TextArea-method-setPosition\" class=\"docClass\">setPosition</a>.\nThis method fires the <a href=\"#/api/Ext.form.field.TextArea-event-move\" rel=\"Ext.form.field.TextArea-event-move\" class=\"docClass\">move</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Sets the left and top of the component.  To set the page XY position instead, use <a href=\"#/api/Ext.form.field.TextArea-method-setPagePosition\" rel=\"Ext.form.field.TextArea-method-setPagePosition\" class=\"docClass\">setPagePosition</a>.\nThis method fires the <a href=\"#/api/Ext.form.field.TextArea-event-move\" rel=\"Ext.form.field.TextArea-event-move\" class=\"docClass\">move</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Sets the field's raw value directly, bypassing <a href=\"#/api/Ext.form.field.TextArea-method-valueToRaw\" rel=\"Ext.form.field.TextArea-method-valueToRaw\" class=\"docClass\">value conversion</a>, change detection, and\nvalidation. To set the value with these additional inspections see <a href=\"#/api/Ext.form.field.TextArea-method-setValue\" rel=\"Ext.form.field.TextArea-method-setValue\" class=\"docClass\">setValue</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "width",
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.form.field.TextArea-method-getEl\" rel=\"Ext.form.field.TextArea-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n"
          },
          {
            "type": "Number/String",
            "properties": [
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the width and height of this Component. This method fires the <a href=\"#/api/Ext.form.field.TextArea-event-resize\" rel=\"Ext.form.field.TextArea-event-resize\" class=\"docClass\">resize</a> event. This method can accept\neither width and height as separate arguments, or you can pass a size object like <code>{width:10, height:20}</code>.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Text.js",
        "doc": "<p>Sets a data value into the field and runs the change detection and validation. Also applies any configured\n<a href=\"#/api/Ext.form.field.TextArea-cfg-emptyText\" rel=\"Ext.form.field.TextArea-cfg-emptyText\" class=\"docClass\">emptyText</a> for text fields. To set the value directly without these inspections see <a href=\"#/api/Ext.form.field.TextArea-method-setRawValue\" rel=\"Ext.form.field.TextArea-method-setRawValue\" class=\"docClass\">setRawValue</a>.</p>\n",
        "return": {
          "type": "Ext.form.field.Text",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.form.field.TextArea-event-resize\" rel=\"Ext.form.field.TextArea-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.form.field.TextArea-cfg-autoRender\" rel=\"Ext.form.field.TextArea-cfg-autoRender\" class=\"docClass\">autoRender</a> or <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.form.field.TextArea-property-zIndexManager\" rel=\"Ext.form.field.TextArea-property-zIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "queueSuspended",
            "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.form.field.TextArea-method-resumeEvents\" rel=\"Ext.form.field.TextArea-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events.</p>\n"
          }
        ],
        "alias": null,
        "name": "suspendEvents",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Suspends the firing of all events. (see <a href=\"#/api/Ext.form.field.TextArea-method-resumeEvents\" rel=\"Ext.form.field.TextArea-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/util/Animate.js",
        "doc": "<p>Ensures that all effects queued after syncFx is called on this object are\nrun concurrently.  This is the opposite of <a href=\"#/api/Ext.form.field.TextArea-method-sequenceFx\" rel=\"Ext.form.field.TextArea-method-sequenceFx\" class=\"docClass\">sequenceFx</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.field.TextArea-method-removeListener\" rel=\"Ext.form.field.TextArea-method-removeListener\" class=\"docClass\">removeListener</a>.</p>\n\n<p>Removes an event handler.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>Returns whether or not the field value is currently valid by <a href=\"#/api/Ext.form.field.TextArea-method-getErrors\" rel=\"Ext.form.field.TextArea-method-getErrors\" class=\"docClass\">validating</a> the field's current\nvalue, and fires the <a href=\"#/api/Ext.form.field.TextArea-event-validitychange\" rel=\"Ext.form.field.TextArea-event-validitychange\" class=\"docClass\">validitychange</a> event if the field's validity has changed since the last validation.\n<strong>Note</strong>: <a href=\"#/api/Ext.form.field.TextArea-cfg-disabled\" rel=\"Ext.form.field.TextArea-cfg-disabled\" class=\"docClass\">disabled</a> fields are always treated as valid.</p>\n\n<p>Custom implementations of this method are allowed to have side-effects such as triggering error message display.\nTo validate without side-effects, use <a href=\"#/api/Ext.form.field.TextArea-method-isValid\" rel=\"Ext.form.field.TextArea-method-isValid\" class=\"docClass\">isValid</a>.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Uses <a href=\"#/api/Ext.form.field.TextArea-method-getErrors\" rel=\"Ext.form.field.TextArea-method-getErrors\" class=\"docClass\">getErrors</a> to build an array of validation errors. If any errors are found, they are passed to\n<a href=\"#/api/Ext.form.field.TextArea-method-markInvalid\" rel=\"Ext.form.field.TextArea-method-markInvalid\" class=\"docClass\">markInvalid</a> and false is returned, otherwise true is returned.</p>\n\n<p>Previously, subclasses were invited to provide an implementation of this to process validations - from 3.2\nonwards <a href=\"#/api/Ext.form.field.TextArea-method-getErrors\" rel=\"Ext.form.field.TextArea-method-getErrors\" class=\"docClass\">getErrors</a> should be overridden instead.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Base.js",
        "doc": "<p>Converts a mixed-type value to a raw representation suitable for displaying in the field. This allows controlling\nhow value objects passed to <a href=\"#/api/Ext.form.field.TextArea-method-setValue\" rel=\"Ext.form.field.TextArea-method-setValue\" class=\"docClass\">setValue</a> are shown to the user, including localization. For instance, for a\n<a href=\"#/api/Ext.form.field.Date\" rel=\"Ext.form.field.Date\" class=\"docClass\">Ext.form.field.Date</a>, this would control how a Date object passed to <a href=\"#/api/Ext.form.field.TextArea-method-setValue\" rel=\"Ext.form.field.TextArea-method-setValue\" class=\"docClass\">setValue</a> would be converted\nto a String for display in the field.</p>\n\n<p>See <a href=\"#/api/Ext.form.field.TextArea-method-rawToValue\" rel=\"Ext.form.field.TextArea-method-rawToValue\" class=\"docClass\">rawToValue</a> for the opposite conversion.</p>\n\n<p>The base implementation simply does a standard toString conversion, and converts <a href=\"#/api/Ext-method-isEmpty\" rel=\"Ext-method-isEmpty\" class=\"docClass\">empty values</a>\nto an empty string.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
    ...
    "property": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Labelable.js",
        "doc": "<p>The div Element that will contain the component's error message(s). Note that depending on the\nconfigured <a href=\"#/api/Ext.form.field.TextArea-cfg-msgTarget\" rel=\"Ext.form.field.TextArea-cfg-msgTarget\" class=\"docClass\">msgTarget</a>, this element may be hidden in favor of some other form of\npresentation, but will always be present in the DOM for use by assistive technologies.</p>\n"
      },
      {
        "static": false,
        "type": "Ext.Container",
        ...
        "shortDoc": "Optional. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Components which were inserted as descendant items of floating Containers.</p>\n\n\n<p>Floating Components that are programatically <a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a> will not have a <code>floatParent</code> property.</p>\n\n\n<p>For <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Components which are child items of a Container, the floatParent will be the floating ancestor Container which is\nresponsible for the base z-index value of all its floating descendants. It provides a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> which provides\nz-indexing services for all its descendant floating Components.</p>\n\n\n<p>For example, the dropdown <a href=\"#/api/Ext.view.BoundList\" rel=\"Ext.view.BoundList\" class=\"docClass\">BoundList</a> of a ComboBox which is in a Window will have the Window as its\n<code>floatParent</code></p>\n\n\n<p>See <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.form.field.TextArea-property-zIndexManager\" rel=\"Ext.form.field.TextArea-property-zIndexManager\" class=\"docClass\">zIndexManager</a></p>\n\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/field/Field.js",
        "doc": "<p>The original value of the field as configured in the <a href=\"#/api/Ext.form.field.TextArea-cfg-value\" rel=\"Ext.form.field.TextArea-cfg-value\" class=\"docClass\">value</a> configuration, or as loaded by the last\nform load operation if the form's <a href=\"#/api/Ext.form.Basic-cfg-trackResetOnLoad\" rel=\"Ext.form.Basic-cfg-trackResetOnLoad\" class=\"docClass\">trackResetOnLoad</a> setting is <code>true</code>.</p>\n"
      },
      {
        "static": false,
        "type": "Ext.Container",
      ...
      },
      {
        ...
        "shortDoc": "Optional. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Components after they have been rendered.</p>\n\n\n<p>A reference to the ZIndexManager which is managing this Component's z-index.</p>\n\n\n<p>The <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> maintains a stack of floating Component z-indices, and also provides a single modal\nmask which is insert just beneath the topmost visible modal floating Component.</p>\n\n\n<p>Floating Components may be <a href=\"#/api/Ext.form.field.TextArea-method-toFront\" rel=\"Ext.form.field.TextArea-method-toFront\" class=\"docClass\">brought to the front</a> or <a href=\"#/api/Ext.form.field.TextArea-method-toBack\" rel=\"Ext.form.field.TextArea-method-toBack\" class=\"docClass\">sent to the back</a> of the z-index stack.</p>\n\n\n<p>This defaults to the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> for floating Components that are programatically\n<a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a>.</p>\n\n\n<p>For <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> Components which are added to a Container, the ZIndexManager is acquired from the first ancestor Container found\nwhich is floating, or if not found the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> is used.</p>\n\n\n<p>See <a href=\"#/api/Ext.form.field.TextArea-cfg-floating\" rel=\"Ext.form.field.TextArea-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.form.field.TextArea-property-floatParent\" rel=\"Ext.form.field.TextArea-property-floatParent\" class=\"docClass\">floatParent</a></p>\n\n"
      }
    ]
  },
  "deprecated": null,
