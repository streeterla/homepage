Ext.data.JsonP.Ext_form_Panel({
  ...
  "href": "Panel.html#Ext-form-Panel",
  "subclasses": [
  ...
  "members": {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "doc": "<p>A tag name or <a href=\"#/api/Ext.DomHelper\" rel=\"Ext.DomHelper\" class=\"docClass\">DomHelper</a> spec used to create the <a href=\"#/api/Ext.form.Panel-method-getEl\" rel=\"Ext.form.Panel-method-getEl\" class=\"docClass\">Element</a> which will\nencapsulate this Component.</p>\n\n\n<p>You do not normally need to specify this. For the base classes <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Ext.Component</a> and <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Ext.container.Container</a>,\nthis defaults to <b><tt>'div'</tt></b>. The more complex Sencha classes use a more complex\nDOM structure specified by their own <a href=\"#/api/Ext.form.Panel-cfg-renderTpl\" rel=\"Ext.form.Panel-cfg-renderTpl\" class=\"docClass\">renderTpl</a>s.</p>\n\n\n<p>This is intended to allow the developer to create application-specific utility Components encapsulated by\ndifferent DOM elements. Example usage:</p>\n\n\n<pre><code>{\n    xtype: 'component',\n    autoEl: {\n        tag: 'img',\n        src: 'http://www.example.com/example.jpg'\n    }\n}, {\n    xtype: 'component',\n    autoEl: {\n        tag: 'blockquote',\n        html: 'autoEl is cool!'\n    }\n}, {\n    xtype: 'container',\n    autoEl: 'ul',\n    cls: 'ux-unordered-list',\n    items: {\n        xtype: 'component',\n        autoEl: 'li',\n        html: 'First list item'\n    }\n}\n</code></pre>\n\n"
      },
      {
        "static": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>This config is intended mainly for <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Components which may or may not be shown. Instead\nof using <a href=\"#/api/Ext.form.Panel-cfg-renderTo\" rel=\"Ext.form.Panel-cfg-renderTo\" class=\"docClass\">renderTo</a> in the configuration, and rendering upon construction, this allows a Component\nto render itself upon first <i><a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a></i>.</p>\n\n\n<p>Specify as <code>true</code> to have this Component render to the document body upon first show.</p>\n\n\n<p>Specify as an element, or the ID of an element to have this Component render to a specific element upon first show.</p>\n\n\n<p><b>This defaults to <code>true</code> for the <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Window</a> class.</b></p>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>True to automatically show the component upon creation.\nThis config option may only be used for <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> components or components\nthat use <a href=\"#/api/Ext.form.Panel-cfg-autoRender\" rel=\"Ext.form.Panel-cfg-autoRender\" class=\"docClass\">autoRender</a>. Defaults to <tt>false</tt>.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/panel/AbstractPanel.js",
        "doc": "<p>A shortcut to add or remove the border on the body of a panel. This only applies to a panel which has the <a href=\"#/api/Ext.form.Panel-cfg-frame\" rel=\"Ext.form.Panel-cfg-frame\" class=\"docClass\">frame</a> configuration set to <code>true</code>.\nDefaults to <code>undefined</code>.</p>\n"
      },
      {
        "static": false,
        "type": "String/String[]",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Convenience config used for adding buttons docked to the bottom of the panel. This is a\nsynonym for the <a href=\"#/api/Ext.form.Panel-cfg-fbar\" rel=\"Ext.form.Panel-cfg-fbar\" class=\"docClass\">fbar</a> config.</p>\n\n<pre><code>buttons: [\n  { text: 'Button 1' }\n]\n</code></pre>\n\n<p>is equivalent to</p>\n\n<pre><code>dockedItems: [{\n    xtype: 'toolbar',\n    dock: 'bottom',\n    ui: 'footer',\n    defaults: {minWidth: <a href=\"#/api/Ext.form.Panel-cfg-minButtonWidth\" rel=\"Ext.form.Panel-cfg-minButtonWidth\" class=\"docClass\">minButtonWidth</a>},\n    items: [\n        { xtype: 'component', flex: 1 },\n        { xtype: 'button', text: 'Button 1' }\n    ]\n}]\n</code></pre>\n\n<p>The <a href=\"#/api/Ext.form.Panel-cfg-minButtonWidth\" rel=\"Ext.form.Panel-cfg-minButtonWidth\" class=\"docClass\">minButtonWidth</a> is used as the default <a href=\"#/api/Ext.button.Button-cfg-minWidth\" rel=\"Ext.button.Button-cfg-minWidth\" class=\"docClass\">minWidth</a> for\neach of the buttons in the buttons toolbar.</p>\n"
      },
      {
        "static": false,
        "type": "Object[]",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>True to display the 'close' tool button and allow the user to close the window, false to hide the button and\ndisallow closing the window (defaults to <code>false</code>).</p>\n\n<p>By default, when close is requested by clicking the close button in the header, the <a href=\"#/api/Ext.form.Panel-method-close\" rel=\"Ext.form.Panel-method-close\" class=\"docClass\">close</a> method will be\ncalled. This will <em><a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a></em> the Panel and its content meaning that it may not be\nreused.</p>\n\n<p>To make closing a Panel <em>hide</em> the Panel so that it may be reused, set <a href=\"#/api/Ext.form.Panel-cfg-closeAction\" rel=\"Ext.form.Panel-cfg-closeAction\" class=\"docClass\">closeAction</a> to 'hide'.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>The action to take when the close header tool is clicked:</p>\n\n<ul>\n<li><p><strong><code>'<a href=\"#/api/Ext.form.Panel-method-destroy\" rel=\"Ext.form.Panel-method-destroy\" class=\"docClass\">destroy</a>'</code></strong> : <strong>Default</strong></p>\n\n<p><a href=\"#/api/Ext.form.Panel-method-destroy\" rel=\"Ext.form.Panel-method-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a> it and all descendant\nComponents. The window will <strong>not</strong> be available to be redisplayed via the <a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a> method.</p></li>\n<li><p><strong><code>'<a href=\"#/api/Ext.form.Panel-method-hide\" rel=\"Ext.form.Panel-method-hide\" class=\"docClass\">hide</a>'</code></strong> :</p>\n\n<p><a href=\"#/api/Ext.form.Panel-method-hide\" rel=\"Ext.form.Panel-method-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets. The window will be\navailable to be redisplayed via the <a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a> method.</p></li>\n</ul>\n\n\n<p><strong>Note:</strong> This behavior has changed! setting <em>does</em> affect the <a href=\"#/api/Ext.form.Panel-method-close\" rel=\"Ext.form.Panel-method-close\" class=\"docClass\">close</a> method which will invoke the\napproriate closeAction.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>The direction to collapse the Panel when the toggle button is clicked.</p>\n\n<p>Defaults to the <a href=\"#/api/Ext.form.Panel-cfg-headerPosition\" rel=\"Ext.form.Panel-cfg-headerPosition\" class=\"docClass\">headerPosition</a></p>\n\n<p><strong>Important: This config is <em>ignored</em> for <a href=\"#/api/Ext.form.Panel-cfg-collapsible\" rel=\"Ext.form.Panel-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</strong></p>\n\n<p>Specify as <code>'top'</code>, <code>'bottom'</code>, <code>'left'</code> or <code>'right'</code>.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>True to make the panel collapsible and have an expand/collapse toggle Tool added into the header tool button\narea. False to keep the panel sized either statically, or by an owning layout manager, with no toggle Tool\n(defaults to false).</p>\n\n<p>See <a href=\"#/api/Ext.form.Panel-cfg-collapseMode\" rel=\"Ext.form.Panel-cfg-collapseMode\" class=\"docClass\">collapseMode</a> and <a href=\"#/api/Ext.form.Panel-cfg-collapseDirection\" rel=\"Ext.form.Panel-cfg-collapseDirection\" class=\"docClass\">collapseDirection</a></p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "name": "data",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>The initial set of data to apply to the <code><a href=\"#/api/Ext.form.Panel-cfg-tpl\" rel=\"Ext.form.Panel-cfg-tpl\" class=\"docClass\">tpl</a></code> to\nupdate the content area of the Component.</p>\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "shortDoc": "Important: This config is only effective for collapsible Panels which are direct child items of a\nborder layout. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><strong>Important: This config is only effective for <a href=\"#/api/Ext.form.Panel-cfg-collapsible\" rel=\"Ext.form.Panel-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a\n<a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</strong></p>\n\n<p>true to allow clicking a collapsed Panel's <a href=\"#/api/Ext.form.Panel-cfg-placeholder\" rel=\"Ext.form.Panel-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated above the layout,\nfalse to force the user to fully expand a collapsed region by clicking the expand button to see it again\n(defaults to true).</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.form.Panel-cfg-collapsible\" rel=\"Ext.form.Panel-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>, <code>false</code> to display it\n(defaults to <code>false</code>).</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>An HTML fragment, or a <a href=\"#/api/Ext.DomHelper\" rel=\"Ext.DomHelper\" class=\"docClass\">DomHelper</a> specification to use as the layout element\ncontent (defaults to ''). The HTML content is added after the component is rendered,\nso the document will not contain this HTML at the time the <a href=\"#/api/Ext.form.Panel-event-render\" rel=\"Ext.form.Panel-event-render\" class=\"docClass\">render</a> event is fired.\nThis content is inserted into the body <i>before</i> any configured <a href=\"#/api/Ext.form.Panel-cfg-contentEl\" rel=\"Ext.form.Panel-cfg-contentEl\" class=\"docClass\">contentEl</a> is appended.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>The <b><u>unique id of this component instance</u></b> (defaults to an <a href=\"#/api/Ext.form.Panel-method-getId\" rel=\"Ext.form.Panel-method-getId\" class=\"docClass\">auto-assigned id</a>).</p>\n\n\n<p>It should not be necessary to use this configuration except for singleton objects in your application.\nComponents created with an id may be accessed globally using <a href=\"#/api/Ext-method-getCmp\" rel=\"Ext-method-getCmp\" class=\"docClass\">Ext.getCmp</a>.</p>\n\n\n<p>Instead of using assigned ids, use the <a href=\"#/api/Ext.form.Panel-cfg-itemId\" rel=\"Ext.form.Panel-cfg-itemId\" class=\"docClass\">itemId</a> config, and <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> which\nprovides selector-based searching for Sencha Components analogous to DOM querying. The <a href=\"#/api/Ext.container.Container\" rel=\"Ext.container.Container\" class=\"docClass\">Container</a>\nclass contains <a href=\"#/api/Ext.container.Container-method-down\" rel=\"Ext.container.Container-method-down\" class=\"docClass\">shortcut methods</a> to query its descendant Components by selector.</p>\n\n\n<p>Note that this id will also be used as the element id for the containing HTML element\nthat is rendered to the page for this component. This allows you to write id-based CSS\nrules to style the specific instance of this component uniquely, and also to select\nsub-elements using this component's id as the parent.</p>\n\n\n<p><b>Note</b>: to avoid complications imposed by a unique <tt>id</tt> also see <code><a href=\"#/api/Ext.form.Panel-cfg-itemId\" rel=\"Ext.form.Panel-cfg-itemId\" class=\"docClass\">itemId</a></code>.</p>\n\n\n<p><b>Note</b>: to access the container of a Component see <code><a href=\"#/api/Ext.form.Panel-property-ownerCt\" rel=\"Ext.form.Panel-property-ownerCt\" class=\"docClass\">ownerCt</a></code>.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "properties": null,
        "linenr": 146,
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-cfg-layout",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        "alias": null,
        "name": "layout",
        "shortDoc": "The Ext.container.Container.layout for the form panel's immediate child items. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>The <a href=\"#/api/Ext.container.Container-cfg-layout\" rel=\"Ext.container.Container-cfg-layout\" class=\"docClass\">Ext.container.Container.layout</a> for the form panel's immediate child items.\nDefaults to <code>'anchor'</code>.</p>\n"
      },
      {
        "static": false,
        "type": "Object/Object[]",
      ...
      },
      {
        ...
        "doc": "<p>A config object containing one or more event handlers to be added to this object during initialization. This\nshould be a valid listeners config object as specified in the <a href=\"#/api/Ext.form.Panel-method-addListener\" rel=\"Ext.form.Panel-method-addListener\" class=\"docClass\">addListener</a> example for attaching multiple\nhandlers at once.</p>\n\n<p><strong>DOM events from ExtJS <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Components</a></strong></p>\n\n<p>While <em>some</em> ExtJs Component classes export selected DOM events (e.g. \"click\", \"mouseover\" etc), this is usually\nonly done when extra value can be added. For example the <a href=\"#/api/Ext.view.View\" rel=\"Ext.view.View\" class=\"docClass\">DataView</a>'s <strong><code><a href=\"#/api/Ext.view.View-event-itemclick\" rel=\"Ext.view.View-event-itemclick\" class=\"docClass\">itemclick</a></code></strong> event passing the node clicked on. To access DOM events directly from a\nchild element of a Component, we need to specify the <code>element</code> option to identify the Component property to add a\nDOM listener to:</p>\n\n<pre><code>new Ext.panel.Panel({\n    width: 400,\n    height: 200,\n    dockedItems: [{\n        xtype: 'toolbar'\n    }],\n    listeners: {\n        click: {\n            element: 'el', //bind to the underlying el property on the panel\n            fn: function(){ console.log('click el'); }\n        },\n        dblclick: {\n            element: 'body', //bind to the underlying body property on the panel\n            fn: function(){ console.log('dblclick body'); }\n        }\n    }\n});\n</code></pre>\n"
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-cfg-pollForChanges",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-cfg-pollInterval",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "cfg",
        "alias": null,
        "name": "pollInterval",
        "shortDoc": "Interval in milliseconds at which the form's fields are checked for value changes. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>An array of events that, when fired, should trigger this object to\nsave its state (defaults to none). <code>stateEvents</code> may be any type\nof event supported by this object, including browser or custom events\n(e.g., <tt>['click', 'customerchange']</tt>).</p>\n\n\n<p>See <code><a href=\"#/api/Ext.form.Panel-cfg-stateful\" rel=\"Ext.form.Panel-cfg-stateful\" class=\"docClass\">stateful</a></code> for an explanation of saving and\nrestoring object state.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>The unique id for this object to use for state management purposes.</p>\n\n<p>See <a href=\"#/api/Ext.form.Panel-cfg-stateful\" rel=\"Ext.form.Panel-cfg-stateful\" class=\"docClass\">stateful</a> for an explanation of saving and restoring state.</p>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/state/Stateful.js",
        "doc": "<p>A flag which causes the object to attempt to restore the state of\ninternal properties from a saved state on startup. The object must have\na <code><a href=\"#/api/Ext.form.Panel-cfg-stateId\" rel=\"Ext.form.Panel-cfg-stateId\" class=\"docClass\">stateId</a></code> for state to be managed.\nAuto-generated ids are not guaranteed to be stable across page loads and\ncannot be relied upon to save and restore the same state for a object.<p>\n<p>For state saving to work, the state manager's provider must have been\nset to an implementation of <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> which overrides the\n<a href=\"#/api/Ext.state.Provider-method-set\" rel=\"Ext.state.Provider-method-set\" class=\"docClass\">set</a> and <a href=\"#/api/Ext.state.Provider-method-get\" rel=\"Ext.state.Provider-method-get\" class=\"docClass\">get</a>\nmethods to save and recall name/value pairs. A built-in implementation,\n<a href=\"#/api/Ext.state.CookieProvider\" rel=\"Ext.state.CookieProvider\" class=\"docClass\">Ext.state.CookieProvider</a> is available.</p>\n<p>To set the state provider for the current page:</p>\n<pre><code>Ext.state.Manager.setProvider(new Ext.state.CookieProvider({\n    expires: new Date(new Date().getTime()+(1000*60*60*24*7)), //7 days from now\n}));\n</code></pre>\n<p>A stateful object attempts to save state when one of the events\nlisted in the <code><a href=\"#/api/Ext.form.Panel-cfg-stateEvents\" rel=\"Ext.form.Panel-cfg-stateEvents\" class=\"docClass\">stateEvents</a></code> configuration fires.</p>\n<p>To save state, a stateful object first serializes its state by\ncalling <b><code><a href=\"#/api/Ext.form.Panel-method-getState\" rel=\"Ext.form.Panel-method-getState\" class=\"docClass\">getState</a></code></b>. By default, this function does\nnothing. The developer must provide an implementation which returns an\nobject hash which represents the restorable state of the object.</p>\n<p>The value yielded by getState is passed to <a href=\"#/api/Ext.state.Manager-method-set\" rel=\"Ext.state.Manager-method-set\" class=\"docClass\">Ext.state.Manager.set</a>\nwhich uses the configured <a href=\"#/api/Ext.state.Provider\" rel=\"Ext.state.Provider\" class=\"docClass\">Ext.state.Provider</a> to save the object\nkeyed by the <code><a href=\"#/api/Ext.form.Panel-cfg-stateId\" rel=\"Ext.form.Panel-cfg-stateId\" class=\"docClass\">stateId</a></code></p>.\n<p>During construction, a stateful object attempts to <i>restore</i>\nits state by calling <a href=\"#/api/Ext.state.Manager-method-get\" rel=\"Ext.state.Manager-method-get\" class=\"docClass\">Ext.state.Manager.get</a> passing the\n<code><a href=\"#/api/Ext.form.Panel-cfg-stateId\" rel=\"Ext.form.Panel-cfg-stateId\" class=\"docClass\">stateId</a></code></p>\n<p>The resulting object is passed to <b><code><a href=\"#/api/Ext.form.Panel-method-applyState\" rel=\"Ext.form.Panel-method-applyState\" class=\"docClass\">applyState</a></code></b>.\nThe default implementation of <code><a href=\"#/api/Ext.form.Panel-method-applyState\" rel=\"Ext.form.Panel-method-applyState\" class=\"docClass\">applyState</a></code> simply copies\nproperties into the object, but a developer may override this to support\nmore behaviour.</p>\n<p>You can perform extra processing on state save and restore by attaching\nhandlers to the <a href=\"#/api/Ext.form.Panel-event-beforestaterestore\" rel=\"Ext.form.Panel-event-beforestaterestore\" class=\"docClass\">beforestaterestore</a>, <a href=\"#/api/Ext.form.Panel-event-staterestore\" rel=\"Ext.form.Panel-event-staterestore\" class=\"docClass\">staterestore</a>,\n<a href=\"#/api/Ext.form.Panel-event-beforestatesave\" rel=\"Ext.form.Panel-event-beforestatesave\" class=\"docClass\">beforestatesave</a> and <a href=\"#/api/Ext.form.Panel-event-statesave\" rel=\"Ext.form.Panel-event-statesave\" class=\"docClass\">statesave</a> events.</p>\n\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.form.Panel-cfg-collapsible\" rel=\"Ext.form.Panel-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>) by clicking anywhere in\nthe header bar, <code>false</code>) to allow it only by clicking to tool button (defaults to <code>false</code>)).</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.form.Panel-method-toFront\" rel=\"Ext.form.Panel-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n"
      },
      {
        "static": false,
    ...
    "event": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component rendering is finished.</p>\n\n\n<p>The afterrender event is fired after this Component has been <a href=\"#/api/Ext.form.Panel-property-rendered\" rel=\"Ext.form.Panel-property-rendered\" class=\"docClass\">rendered</a>, been postprocesed\nby any afterRender method defined for the Component.</p>\n\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.form.Panel-method-destroy\" rel=\"Ext.form.Panel-method-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.form.Panel-method-destroy\" rel=\"Ext.form.Panel-method-destroy\" class=\"docClass\">destroy</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.form.Panel-method-hide\" rel=\"Ext.form.Panel-method-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.form.Panel-property-rendered\" rel=\"Ext.form.Panel-property-rendered\" class=\"docClass\">rendered</a>. Return false from an\nevent handler to stop the <a href=\"#/api/Ext.form.Panel-event-render\" rel=\"Ext.form.Panel-event-render\" class=\"docClass\">render</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.form.Panel-method-destroy\" rel=\"Ext.form.Panel-method-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.form.Panel-method-hide\" rel=\"Ext.form.Panel-method-hide\" class=\"docClass\">hide</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component markup is <a href=\"#/api/Ext.form.Panel-property-rendered\" rel=\"Ext.form.Panel-property-rendered\" class=\"docClass\">rendered</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.form.Panel-method-show\" rel=\"Ext.form.Panel-method-show\" class=\"docClass\">show</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
    ...
    "method": [
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "component",
            "doc": "<p>Either one or more Components to add or an Array of Components to add.\nSee <code><a href=\"#/api/Ext.form.Panel-property-items\" rel=\"Ext.form.Panel-property-items\" class=\"docClass\">items</a></code> for additional information.</p>\n"
          }
        ],
        "alias": null,
        "name": "add",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/container/AbstractContainer.js",
        "doc": "<p>Adds <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Component</a>(s) to this Container.</p>\n\n<h2>Description:</h2>\n\n<ul>\n<li>Fires the <a href=\"#/api/Ext.form.Panel-event-beforeadd\" rel=\"Ext.form.Panel-event-beforeadd\" class=\"docClass\">beforeadd</a> event before adding.</li>\n<li>The Container's <a href=\"#/api/Ext.form.Panel-cfg-defaults\" rel=\"Ext.form.Panel-cfg-defaults\" class=\"docClass\">default config values</a> will be applied\naccordingly (see <code><a href=\"#/api/Ext.form.Panel-cfg-defaults\" rel=\"Ext.form.Panel-cfg-defaults\" class=\"docClass\">defaults</a></code> for details).</li>\n<li>Fires the <code><a href=\"#/api/Ext.form.Panel-method-add\" rel=\"Ext.form.Panel-method-add\" class=\"docClass\">add</a></code> event after the component has been added.</li>\n</ul>\n\n\n<h2>Notes:</h2>\n\n<p>If the Container is <strong>already rendered</strong> when <code>add</code>\nis called, it will render the newly added Component into its content area.</p>\n\n<p><strong><strong>If</strong></strong> the Container was configured with a size-managing <a href=\"#/api/Ext.form.Panel-cfg-layout\" rel=\"Ext.form.Panel-cfg-layout\" class=\"docClass\">layout</a> manager, the Container\nwill recalculate its internal layout at this time too.</p>\n\n<p>Note that the default layout manager simply renders child Components sequentially into the content area and thereafter performs no sizing.</p>\n\n<p>If adding multiple new child Components, pass them as an array to the <code>add</code> method, so that only one layout recalculation is performed.</p>\n\n<pre><code>tb = new <a href=\"#/api/Ext.toolbar.Toolbar\" rel=\"Ext.toolbar.Toolbar\" class=\"docClass\">Ext.toolbar.Toolbar</a>({\n    renderTo: document.body\n});  // toolbar is rendered\ntb.add([{text:'Button 1'}, {text:'Button 2'}]); // add multiple items. (<a href=\"#/api/Ext.form.Panel-cfg-defaultType\" rel=\"Ext.form.Panel-cfg-defaultType\" class=\"docClass\">defaultType</a> for <a href=\"#/api/Ext.toolbar.Toolbar\" rel=\"Ext.toolbar.Toolbar\" class=\"docClass\">Toolbar</a> is 'button')\n</code></pre>\n\n<h2>Warning:</h2>\n\n<p>Components directly managed by the BorderLayout layout manager\nmay not be removed or added.  See the Notes for <a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">BorderLayout</a>\nfor more details.</p>\n",
        "return": {
          "type": "Ext.Component[]/Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Adds each argument passed to this method to the <a href=\"#/api/Ext.form.Panel-cfg-childEls\" rel=\"Ext.form.Panel-cfg-childEls\" class=\"docClass\">childEls</a> array.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Adds a cls to the uiCls array, which will also call <a href=\"#/api/Ext.form.Panel-method-addUIClsToElement\" rel=\"Ext.form.Panel-method-addUIClsToElement\" class=\"docClass\">addUIClsToElement</a> and adds\nto all elements of this component.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The method the event invokes.  Will be called with arguments given to\n<a href=\"#/api/Ext.form.Panel-method-fireEvent\" rel=\"Ext.form.Panel-method-fireEvent\" class=\"docClass\">fireEvent</a> plus the <code>options</code> parameter described below.</p>\n"
          },
          {
            "type": "Object",
            "properties": [
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-checkChange",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a>s the\nPanel object and all its descendant Components. The <a href=\"#/api/Ext.form.Panel-event-beforeclose\" rel=\"Ext.form.Panel-event-beforeclose\" class=\"docClass\">beforeclose</a> event is fired before the\nclose happens and will cancel the close action if it returns false.</p>\n\n<p><strong>Note:</strong> This method is not affected by the <a href=\"#/api/Ext.form.Panel-cfg-closeAction\" rel=\"Ext.form.Panel-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which only affects the action triggered\nwhen clicking the <a href=\"#/api/Ext.form.Panel-cfg-closable\" rel=\"Ext.form.Panel-cfg-closable\" class=\"docClass\">'close' tool in the header</a>. To hide the Panel without destroying it, call\n<a href=\"#/api/Ext.form.Panel-method-hide\" rel=\"Ext.form.Panel-method-hide\" class=\"docClass\">hide</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "animate",
            "doc": "<p>True to animate the transition, else false (defaults to the value of the\n<a href=\"#/api/Ext.form.Panel-cfg-animCollapse\" rel=\"Ext.form.Panel-cfg-animCollapse\" class=\"docClass\">animCollapse</a> panel config)</p>\n"
          }
        ],
        "alias": null,
        "name": "collapse",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the border towards which\nthe collapse takes place will remain visible. Fires the <a href=\"#/api/Ext.form.Panel-event-beforecollapse\" rel=\"Ext.form.Panel-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will cancel the\ncollapse action if it returns false.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Expands the panel body so that it becomes visible. Fires the <a href=\"#/api/Ext.form.Panel-event-beforeexpand\" rel=\"Ext.form.Panel-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will cancel the\nexpand action if it returns false.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Fires the specified event with the passed parameters (minus the event name, plus the <code>options</code> object passed\nto <a href=\"#/api/Ext.form.Panel-method-addListener\" rel=\"Ext.form.Panel-method-addListener\" class=\"docClass\">addListener</a>).</p>\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>) by\ncalling <a href=\"#/api/Ext.form.Panel-method-enableBubble\" rel=\"Ext.form.Panel-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "comp",
            "doc": "<p>The id, itemId or position of the docked component (see <a href=\"#/api/Ext.form.Panel-method-getComponent\" rel=\"Ext.form.Panel-method-getComponent\" class=\"docClass\">getComponent</a> for details)</p>\n"
          }
        ],
        "alias": null,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/panel/AbstractPanel.js",
        "doc": "<p>Finds a docked component by id, itemId or position. Also see <a href=\"#/api/Ext.form.Panel-method-getDockedItems\" rel=\"Ext.form.Panel-method-getDockedItems\" class=\"docClass\">getDockedItems</a></p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-getForm",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "getForm",
        "shortDoc": "Provides access to the Form which this Panel contains. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Provides access to the <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Form</a> which this Panel contains.</p>\n",
        "return": {
          "type": "Ext.form.Basic",
          "properties": null,
          "name": "return",
          "doc": "<p>The <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Form</a> which this Panel contains.</p>\n"
        }
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-getRecord",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "getRecord",
        "shortDoc": "Returns the currently loaded Ext.data.Model instance if one was loaded via loadRecord. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Returns the currently loaded <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> instance if one was loaded via <a href=\"#/api/Ext.form.Panel-method-loadRecord\" rel=\"Ext.form.Panel-method-loadRecord\" class=\"docClass\">loadRecord</a>.</p>\n",
        "return": {
          "type": "Ext.data.Model",
          "properties": null,
          "name": "return",
          "doc": "<p>The loaded instance</p>\n"
        }
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-getValues",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "getValues",
        "shortDoc": "Convenience function for fetching the current value of each field in the form. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Convenience function for fetching the current value of each field in the form. This is the same as calling\n<a href=\"#/api/Ext.form.Basic-method-getValues\" rel=\"Ext.form.Basic-method-getValues\" class=\"docClass\">this.getForm().getValues()</a></p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
          "doc": "<p>The current form field values, keyed by field name</p>\n"
        }
      },
      {
        "static": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Hides this Component, setting it to invisible using the configured <a href=\"#/api/Ext.form.Panel-cfg-hideMode\" rel=\"Ext.form.Panel-cfg-hideMode\" class=\"docClass\">hideMode</a>.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/container/AbstractContainer.js",
        "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.form.Panel-event-beforeadd\" rel=\"Ext.form.Panel-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.form.Panel-method-add\" rel=\"Ext.form.Panel-method-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-load",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        "params": [
          {
            ...
            "optional": false,
            "name": "options",
            "doc": "<p>The options to pass to the action (see <a href=\"#/api/Ext.form.Basic-method-load\" rel=\"Ext.form.Basic-method-load\" class=\"docClass\">Ext.form.Basic.load</a> and\n<a href=\"#/api/Ext.form.Basic-method-doAction\" rel=\"Ext.form.Basic-method-doAction\" class=\"docClass\">Ext.form.Basic.doAction</a> for details)</p>\n"
          }
        ],
        "alias": null,
        "name": "load",
        "shortDoc": "This is a proxy for the underlying BasicForm's Ext.form.Basic.load call. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>This is a proxy for the underlying BasicForm's <a href=\"#/api/Ext.form.Basic-method-load\" rel=\"Ext.form.Basic-method-load\" class=\"docClass\">Ext.form.Basic.load</a> call.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-loadRecord",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "loadRecord",
        "shortDoc": "Loads an Ext.data.Model into this form (internally just calls Ext.form.Basic.loadRecord)\nSee also trackResetOnLoad. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Loads an <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> into this form (internally just calls <a href=\"#/api/Ext.form.Basic-method-loadRecord\" rel=\"Ext.form.Basic-method-loadRecord\" class=\"docClass\">Ext.form.Basic.loadRecord</a>)\nSee also <a href=\"#/api/Ext.form.Basic-cfg-trackResetOnLoad\" rel=\"Ext.form.Basic-cfg-trackResetOnLoad\" class=\"docClass\">trackResetOnLoad</a>.</p>\n",
        "return": {
          "type": "Ext.form.Basic",
          "properties": null,
          "name": "return",
          "doc": "<p>The <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Ext.form.Basic</a> attached to this FormPanel</p>\n"
        }
      },
      {
        "static": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.Panel-method-addManagedListener\" rel=\"Ext.form.Panel-method-addManagedListener\" class=\"docClass\">addManagedListener</a>.</p>\n\n<p>Adds listeners to any Observable object (or Ext.Element) which are automatically removed when this Component is\ndestroyed.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.Panel-method-removeManagedListener\" rel=\"Ext.form.Panel-method-removeManagedListener\" class=\"docClass\">removeManagedListener</a>.</p>\n\n<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.Panel-method-mon\" rel=\"Ext.form.Panel-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the next node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree to attempt to find a match. Contrast with <a href=\"#/api/Ext.form.Panel-method-nextSibling\" rel=\"Ext.form.Panel-method-nextSibling\" class=\"docClass\">nextSibling</a>.</p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the next sibling of this Component.</p>\n\n\n<p>Optionally selects the next sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>next()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.form.Panel-method-nextNode\" rel=\"Ext.form.Panel-method-nextNode\" class=\"docClass\">nextNode</a></p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.Panel-method-addListener\" rel=\"Ext.form.Panel-method-addListener\" class=\"docClass\">addListener</a>.</p>\n\n<p>Appends an event handler to this object.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the previous node in the Component tree in tree traversal order.</p>\n\n\n<p>Note that this is not limited to siblings, and if invoked upon a node with no matching siblings, will\nwalk the tree in reverse order to attempt to find a match. Contrast with <a href=\"#/api/Ext.form.Panel-method-previousSibling\" rel=\"Ext.form.Panel-method-previousSibling\" class=\"docClass\">previousSibling</a>.</p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Returns the previous sibling of this Component.</p>\n\n\n<p>Optionally selects the previous sibling which matches the passed <a href=\"#/api/Ext.ComponentQuery\" rel=\"Ext.ComponentQuery\" class=\"docClass\">ComponentQuery</a> selector.</p>\n\n\n<p>May also be refered to as <code><b>prev()</b></code></p>\n\n\n<p>Note that this is limited to siblings, and if no siblings of the item match, <code>null</code> is returned. Contrast with <a href=\"#/api/Ext.form.Panel-method-previousNode\" rel=\"Ext.form.Panel-method-previousNode\" class=\"docClass\">previousNode</a></p>\n\n",
        "return": {
          "type": "undefined",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/container/AbstractContainer.js",
        "doc": "<p>Removes a component from this container.  Fires the <a href=\"#/api/Ext.form.Panel-event-beforeremove\" rel=\"Ext.form.Panel-event-beforeremove\" class=\"docClass\">beforeremove</a> event before removing, then fires\nthe <a href=\"#/api/Ext.form.Panel-method-remove\" rel=\"Ext.form.Panel-method-remove\" class=\"docClass\">remove</a> event after the component has been removed.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Removes a cls to the uiCls array, which will also call <a href=\"#/api/Ext.form.Panel-method-removeUIClsFromElement\" rel=\"Ext.form.Panel-method-removeUIClsFromElement\" class=\"docClass\">removeUIClsFromElement</a> and removes\nit from all elements of this component.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The handler to remove. <strong>This must be a reference to the function passed into the\n<a href=\"#/api/Ext.form.Panel-method-addListener\" rel=\"Ext.form.Panel-method-addListener\" class=\"docClass\">addListener</a> call.</strong></p>\n"
          },
          {
            "type": "Object",
            "properties": [
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.form.Panel-method-addListener\" rel=\"Ext.form.Panel-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.form.Panel-method-mon\" rel=\"Ext.form.Panel-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Resumes firing events (see <a href=\"#/api/Ext.form.Panel-method-suspendEvents\" rel=\"Ext.form.Panel-method-suspendEvents\" class=\"docClass\">suspendEvents</a>).</p>\n\n<p>If events were suspended using the <code>**queueSuspended**</code> parameter, then all events fired\nduring event suspension will be sent to any listeners now.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/util/Animate.js",
        "doc": "<p>Ensures that all effects queued after sequenceFx is called on this object are\nrun in sequence.  This is the opposite of <a href=\"#/api/Ext.form.Panel-method-syncFx\" rel=\"Ext.form.Panel-method-syncFx\" class=\"docClass\">syncFx</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "height",
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.form.Panel-method-getEl\" rel=\"Ext.form.Panel-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n"
          }
        ],
        "alias": null,
        "name": "setHeight",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the height of the component.  This method fires the <a href=\"#/api/Ext.form.Panel-event-resize\" rel=\"Ext.form.Panel-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Sets the page XY position of the component.  To set the left and top instead, use <a href=\"#/api/Ext.form.Panel-method-setPosition\" rel=\"Ext.form.Panel-method-setPosition\" class=\"docClass\">setPosition</a>.\nThis method fires the <a href=\"#/api/Ext.form.Panel-method-move\" rel=\"Ext.form.Panel-method-move\" class=\"docClass\">move</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Sets the left and top of the component.  To set the page XY position instead, use <a href=\"#/api/Ext.form.Panel-method-setPagePosition\" rel=\"Ext.form.Panel-method-setPagePosition\" class=\"docClass\">setPagePosition</a>.\nThis method fires the <a href=\"#/api/Ext.form.Panel-method-move\" rel=\"Ext.form.Panel-method-move\" class=\"docClass\">move</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "width",
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.form.Panel-method-getEl\" rel=\"Ext.form.Panel-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n"
          },
          {
            "type": "Number/String",
            "properties": [
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the width and height of this Component. This method fires the <a href=\"#/api/Ext.form.Panel-event-resize\" rel=\"Ext.form.Panel-event-resize\" class=\"docClass\">resize</a> event. This method can accept\neither width and height as separate arguments, or you can pass a size object like <code>{width:10, height:20}</code>.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Sets the width of the component.  This method fires the <a href=\"#/api/Ext.form.Panel-event-resize\" rel=\"Ext.form.Panel-event-resize\" class=\"docClass\">resize</a> event.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Shows this Component, rendering it first if <a href=\"#/api/Ext.form.Panel-cfg-autoRender\" rel=\"Ext.form.Panel-cfg-autoRender\" class=\"docClass\">autoRender</a> or <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> are <code>true</code>.</p>\n\n\n<p>After being shown, a <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Component (such as a <a href=\"#/api/Ext.window.Window\" rel=\"Ext.window.Window\" class=\"docClass\">Ext.window.Window</a>), is activated it and brought to the front of\nits <a href=\"#/api/Ext.form.Panel-property-zIndexManager\" rel=\"Ext.form.Panel-property-zIndexManager\" class=\"docClass\">z-index stack</a>.</p>\n\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-startPolling",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        "params": [
          {
            ...
            "optional": false,
            "name": "interval",
            "doc": "<p>The interval in milliseconds at which the check should run.</p>\n"
          }
        ],
        "alias": null,
        "name": "startPolling",
        "shortDoc": "Start an interval task to continuously poll all the fields in the form for changes in their\nvalues. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Start an interval task to continuously poll all the fields in the form for changes in their\nvalues. This is normally started automatically by setting the <a href=\"#/api/Ext.form.Panel-cfg-pollForChanges\" rel=\"Ext.form.Panel-cfg-pollForChanges\" class=\"docClass\">pollForChanges</a> config.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-stopPolling",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "stopPolling",
        "shortDoc": "Stop a running interval task that was started by startPolling. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>Stop a running interval task that was started by <a href=\"#/api/Ext.form.Panel-method-startPolling\" rel=\"Ext.form.Panel-method-startPolling\" class=\"docClass\">startPolling</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "owner": "Ext.form.Panel",
        "html_filename": "Panel.html",
        "href": "Panel.html#Ext-form-Panel-method-submit",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        "params": [
          {
            ...
            "optional": false,
            "name": "options",
            "doc": "<p>The options to pass to the action (see <a href=\"#/api/Ext.form.Basic-method-submit\" rel=\"Ext.form.Basic-method-submit\" class=\"docClass\">Ext.form.Basic.submit</a> and\n<a href=\"#/api/Ext.form.Basic-method-doAction\" rel=\"Ext.form.Basic-method-doAction\" class=\"docClass\">Ext.form.Basic.doAction</a> for details)</p>\n"
          }
        ],
        "alias": null,
        "name": "submit",
        "shortDoc": "This is a proxy for the underlying BasicForm's Ext.form.Basic.submit call. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/Panel.js",
        "doc": "<p>This is a proxy for the underlying BasicForm's <a href=\"#/api/Ext.form.Basic-method-submit\" rel=\"Ext.form.Basic-method-submit\" class=\"docClass\">Ext.form.Basic.submit</a> call.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "queueSuspended",
            "doc": "<p>Pass as true to queue up suspended events to be fired\nafter the <a href=\"#/api/Ext.form.Panel-method-resumeEvents\" rel=\"Ext.form.Panel-method-resumeEvents\" class=\"docClass\">resumeEvents</a> call instead of discarding all suspended events.</p>\n"
          }
        ],
        "alias": null,
        "name": "suspendEvents",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Suspends the firing of all events. (see <a href=\"#/api/Ext.form.Panel-method-resumeEvents\" rel=\"Ext.form.Panel-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/util/Animate.js",
        "doc": "<p>Ensures that all effects queued after syncFx is called on this object are\nrun concurrently.  This is the opposite of <a href=\"#/api/Ext.form.Panel-method-sequenceFx\" rel=\"Ext.form.Panel-method-sequenceFx\" class=\"docClass\">sequenceFx</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.form.Panel-method-expand\" rel=\"Ext.form.Panel-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.form.Panel-method-collapse\" rel=\"Ext.form.Panel-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.form.Panel-method-removeListener\" rel=\"Ext.form.Panel-method-removeListener\" class=\"docClass\">removeListener</a>.</p>\n\n<p>Removes an event handler.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
    ...
    "property": [
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.form.Panel-property-draggable\" rel=\"Ext.form.Panel-property-draggable\" class=\"docClass\">draggable</a>, this property will contain an instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> in order to\nsupply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.form.Panel-property-draggable\" rel=\"Ext.form.Panel-property-draggable\" class=\"docClass\">draggable</a>.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "shortDoc": "Optional. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Components which were inserted as descendant items of floating Containers.</p>\n\n\n<p>Floating Components that are programatically <a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a> will not have a <code>floatParent</code> property.</p>\n\n\n<p>For <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Components which are child items of a Container, the floatParent will be the floating ancestor Container which is\nresponsible for the base z-index value of all its floating descendants. It provides a <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> which provides\nz-indexing services for all its descendant floating Components.</p>\n\n\n<p>For example, the dropdown <a href=\"#/api/Ext.view.BoundList\" rel=\"Ext.view.BoundList\" class=\"docClass\">BoundList</a> of a ComboBox which is in a Window will have the Window as its\n<code>floatParent</code></p>\n\n\n<p>See <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.form.Panel-property-zIndexManager\" rel=\"Ext.form.Panel-property-zIndexManager\" class=\"docClass\">zIndexManager</a></p>\n\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "shortDoc": "Optional. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>Optional. Only present for <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Components after they have been rendered.</p>\n\n\n<p>A reference to the ZIndexManager which is managing this Component's z-index.</p>\n\n\n<p>The <a href=\"#/api/Ext.ZIndexManager\" rel=\"Ext.ZIndexManager\" class=\"docClass\">ZIndexManager</a> maintains a stack of floating Component z-indices, and also provides a single modal\nmask which is insert just beneath the topmost visible modal floating Component.</p>\n\n\n<p>Floating Components may be <a href=\"#/api/Ext.form.Panel-method-toFront\" rel=\"Ext.form.Panel-method-toFront\" class=\"docClass\">brought to the front</a> or <a href=\"#/api/Ext.form.Panel-method-toBack\" rel=\"Ext.form.Panel-method-toBack\" class=\"docClass\">sent to the back</a> of the z-index stack.</p>\n\n\n<p>This defaults to the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> for floating Components that are programatically\n<a href=\"#/api/Ext.Component-event-render\" rel=\"Ext.Component-event-render\" class=\"docClass\">rendered</a>.</p>\n\n\n<p>For <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> Components which are added to a Container, the ZIndexManager is acquired from the first ancestor Container found\nwhich is floating, or if not found the global <a href=\"#/api/Ext.WindowManager\" rel=\"Ext.WindowManager\" class=\"docClass\">ZIndexManager</a> is used.</p>\n\n\n<p>See <a href=\"#/api/Ext.form.Panel-cfg-floating\" rel=\"Ext.form.Panel-cfg-floating\" class=\"docClass\">floating</a> and <a href=\"#/api/Ext.form.Panel-property-floatParent\" rel=\"Ext.form.Panel-property-floatParent\" class=\"docClass\">floatParent</a></p>\n\n"
      }
    ]
  },
  "deprecated": null,
