Ext.data.JsonP.Ext_data_DirectStore({
  ...
  "members": {
    ...
    "method": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.DirectStore-method-add\" rel=\"Ext.data.DirectStore-method-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.DirectStore-method-add\" rel=\"Ext.data.DirectStore-method-add\" class=\"docClass\">add</a></code>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "options",
            "doc": "<p>See options for <a href=\"#/api/Ext.data.DirectStore-method-load\" rel=\"Ext.data.DirectStore-method-load\" class=\"docClass\">load</a></p>\n"
          }
        ],
        "alias": null,
        "name": "loadPage",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Loads an array of {@Ext.data.Model model} instances into the store, fires the datachanged event. This should only usually\nbe called internally when loading from the <a href=\"#/api/Ext.data.proxy.Proxy\" rel=\"Ext.data.proxy.Proxy\" class=\"docClass\">Proxy</a>, when adding records manually use <a href=\"#/api/Ext.data.DirectStore-method-add\" rel=\"Ext.data.DirectStore-method-add\" class=\"docClass\">add</a> instead</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
  ...
  "component": false,
  "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/DirectStore.js",
