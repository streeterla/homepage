Ext.data.JsonP.Ext_grid_property_Store({
  "static": false,
  "mixedInto": [
  ...
  "html_filename": "Store.html",
  "allMixins": [
    "Ext.util.Observable",
    "Ext.util.Sortable"
  ],
  "docauthor": null,
  "href": "Store.html#Ext-grid-property-Store",
  "subclasses": [
  ...
  "members": {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
        "doc": "<p>This may be used in place of specifying a <a href=\"#/api/Ext.grid.property.Store-cfg-model\" rel=\"Ext.grid.property.Store-cfg-model\" class=\"docClass\">model</a> configuration. The fields should be a\nset of <a href=\"#/api/Ext.data.Field\" rel=\"Ext.data.Field\" class=\"docClass\">Ext.data.Field</a> configuration objects. The store will automatically create a <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a>\nwith these fields. In general this configuration option should be avoided, it exists for the purposes of\nbackwards compatibility. For anything more complicated, such as specifying a particular id property or\nassocations, a <a href=\"#/api/Ext.data.Model\" rel=\"Ext.data.Model\" class=\"docClass\">Ext.data.Model</a> should be defined and specified for the <a href=\"#/api/Ext.grid.property.Store-cfg-model\" rel=\"Ext.grid.property.Store-cfg-model\" class=\"docClass\">model</a>\nconfig.</p>\n"
      },
      {
        "static": false,
        "type": "Object",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>For local filtering only, causes <a href=\"#/api/Ext.grid.property.Store-method-sort\" rel=\"Ext.grid.property.Store-method-sort\" class=\"docClass\">sort</a> to be called whenever <a href=\"#/api/Ext.grid.property.Store-method-filter\" rel=\"Ext.grid.property.Store-method-filter\" class=\"docClass\">filter</a> is called,\ncausing the sorters to be reapplied after filtering. Defaults to true</p>\n"
      },
      {
        "static": false,
        "type": "String",
    ...
    "event": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
        "doc": "<p>Fired before a call to <a href=\"#/api/Ext.grid.property.Store-method-sync\" rel=\"Ext.grid.property.Store-method-sync\" class=\"docClass\">sync</a> is executed. Return false from any listener to cancel the synv</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
        "doc": "<p>Fired after the <a href=\"#/api/Ext.grid.property.Store-method-removeAll\" rel=\"Ext.grid.property.Store-method-removeAll\" class=\"docClass\">removeAll</a> method is called.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
        "doc": "<p>Fires whenever a successful write has been made via the configured <a href=\"#/api/Ext.grid.property.Store-cfg-proxy\" rel=\"Ext.grid.property.Store-cfg-proxy\" class=\"docClass\">Proxy</a></p>\n"
      }
    ],
    "method": [
      {
        ...
        "inheritable": false,
        "linenr": 16,
        "owner": "Ext.grid.property.Store",
        "html_filename": "Store.html",
        "href": "Store.html#Ext-grid-property-Store-method-constructor",
        "protected": false,
        "deprecated": null,
        "private": false,
        "tagname": "method",
        ...
        "alias": null,
        "name": "constructor",
        "shortDoc": "Creates new property store. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/grid/property/Store.js",
        "doc": "<p>Creates new property store.</p>\n",
        "return": {
          "type": "Object",
          "properties": [
        ...
        "params": [
          {
            ...
            "optional": true,
            "name": "groupName",
            "doc": "<p>(Optional) Pass in an optional groupName argument to access a specific group as defined by <a href=\"#/api/Ext.grid.property.Store-method-getGroupString\" rel=\"Ext.grid.property.Store-method-getGroupString\" class=\"docClass\">getGroupString</a></p>\n"
          }
        ],
        "alias": null,
        "name": "getGroups",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.grid.property.Store-method-add\" rel=\"Ext.grid.property.Store-method-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.grid.property.Store-method-add\" rel=\"Ext.grid.property.Store-method-add\" class=\"docClass\">add</a></code>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "options",
            "doc": "<p>See options for <a href=\"#/api/Ext.grid.property.Store-method-load\" rel=\"Ext.grid.property.Store-method-load\" class=\"docClass\">load</a></p>\n"
          }
        ],
        "alias": null,
        "name": "loadPage",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Loads an array of {@Ext.data.Model model} instances into the store, fires the datachanged event. This should only usually\nbe called internally when loading from the <a href=\"#/api/Ext.data.proxy.Proxy\" rel=\"Ext.data.proxy.Proxy\" class=\"docClass\">Proxy</a>, when adding records manually use <a href=\"#/api/Ext.grid.property.Store-method-add\" rel=\"Ext.grid.property.Store-method-add\" class=\"docClass\">add</a> instead</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.grid.property.Store-method-addManagedListener\" rel=\"Ext.grid.property.Store-method-addManagedListener\" class=\"docClass\">addManagedListener</a>.</p>\n\n<p>Adds listeners to any Observable object (or Ext.Element) which are automatically removed when this Component is\ndestroyed.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.grid.property.Store-method-removeManagedListener\" rel=\"Ext.grid.property.Store-method-removeManagedListener\" class=\"docClass\">removeManagedListener</a>.</p>\n\n<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Store-method-mon\" rel=\"Ext.grid.property.Store-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a>.</p>\n\n<p>Appends an event handler to this object.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Prefetches data into the store using its configured <a href=\"#/api/Ext.grid.property.Store-cfg-proxy\" rel=\"Ext.grid.property.Store-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.grid.property.Store-method-addListener\" rel=\"Ext.grid.property.Store-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.grid.property.Store-method-mon\" rel=\"Ext.grid.property.Store-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Resumes firing events (see <a href=\"#/api/Ext.grid.property.Store-method-suspendEvents\" rel=\"Ext.grid.property.Store-method-suspendEvents\" class=\"docClass\">suspendEvents</a>).</p>\n\n<p>If events were suspended using the <code>**queueSuspended**</code> parameter, then all events fired\nduring event suspension will be sent to any listeners now.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Suspends the firing of all events. (see <a href=\"#/api/Ext.grid.property.Store-method-resumeEvents\" rel=\"Ext.grid.property.Store-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.grid.property.Store-method-removeListener\" rel=\"Ext.grid.property.Store-method-removeListener\" class=\"docClass\">removeListener</a>.</p>\n\n<p>Removes an event handler.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
    ...
    "property": [
      ...
      },
      {
        ...
        "name": "currentPage",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>The page that the Store has most recently loaded (see <a href=\"#/api/Ext.grid.property.Store-method-loadPage\" rel=\"Ext.grid.property.Store-method-loadPage\" class=\"docClass\">loadPage</a>)</p>\n"
      },
      {
        "static": false,
        "type": "Ext.util.MixedCollection",
