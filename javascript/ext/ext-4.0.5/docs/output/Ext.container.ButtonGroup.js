  ...
  "members": {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/container/ButtonGroup.js",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>True to display the 'close' tool button and allow the user to close the window, false to hide the button and\ndisallow closing the window (defaults to <code>false</code>).</p>\n\n<p>By default, when close is requested by clicking the close button in the header, the <a href=\"#/api/Ext.container.ButtonGroup-method-close\" rel=\"Ext.container.ButtonGroup-method-close\" class=\"docClass\">close</a> method will be\ncalled. This will <em><a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a></em> the Panel and its content meaning that it may not be\nreused.</p>\n\n<p>To make closing a Panel <em>hide</em> the Panel so that it may be reused, set <a href=\"#/api/Ext.container.ButtonGroup-cfg-closeAction\" rel=\"Ext.container.ButtonGroup-cfg-closeAction\" class=\"docClass\">closeAction</a> to 'hide'.</p>\n"
      },
      {
        "static": false,
        "type": "String",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>The action to take when the close header tool is clicked:</p>\n\n<ul>\n<li><p><strong><code>'<a href=\"#/api/Ext.container.ButtonGroup-method-destroy\" rel=\"Ext.container.ButtonGroup-method-destroy\" class=\"docClass\">destroy</a>'</code></strong> : <strong>Default</strong></p>\n\n<p><a href=\"#/api/Ext.container.ButtonGroup-method-destroy\" rel=\"Ext.container.ButtonGroup-method-destroy\" class=\"docClass\">remove</a> the window from the DOM and <a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a> it and all descendant\nComponents. The window will <strong>not</strong> be available to be redisplayed via the <a href=\"#/api/Ext.container.ButtonGroup-method-show\" rel=\"Ext.container.ButtonGroup-method-show\" class=\"docClass\">show</a> method.</p></li>\n<li><p><strong><code>'<a href=\"#/api/Ext.container.ButtonGroup-method-hide\" rel=\"Ext.container.ButtonGroup-method-hide\" class=\"docClass\">hide</a>'</code></strong> :</p>\n\n<p><a href=\"#/api/Ext.container.ButtonGroup-method-hide\" rel=\"Ext.container.ButtonGroup-method-hide\" class=\"docClass\">hide</a> the window by setting visibility to hidden and applying negative offsets. The window will be\navailable to be redisplayed via the <a href=\"#/api/Ext.container.ButtonGroup-method-show\" rel=\"Ext.container.ButtonGroup-method-show\" class=\"docClass\">show</a> method.</p></li>\n</ul>\n\n\n<p><strong>Note:</strong> This behavior has changed! setting <em>does</em> affect the <a href=\"#/api/Ext.container.ButtonGroup-method-close\" rel=\"Ext.container.ButtonGroup-method-close\" class=\"docClass\">close</a> method which will invoke the\napproriate closeAction.</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/container/AbstractContainer.js",
        "doc": "<p>This option is a means of applying default settings to all added items whether added through the <a href=\"#/api/Ext.container.ButtonGroup-property-items\" rel=\"Ext.container.ButtonGroup-property-items\" class=\"docClass\">items</a>\nconfig or via the <a href=\"#/api/Ext.container.ButtonGroup-method-add\" rel=\"Ext.container.ButtonGroup-method-add\" class=\"docClass\">add</a> or <a href=\"#/api/Ext.container.ButtonGroup-method-insert\" rel=\"Ext.container.ButtonGroup-method-insert\" class=\"docClass\">insert</a> methods.</p>\n\n\n<p>If an added item is a config object, and <b>not</b> an instantiated Component, then the default properties are\nunconditionally applied. If the added item <b>is</b> an instantiated Component, then the default properties are\napplied conditionally so as not to override existing properties in the item.</p>\n\n\n<p>If the defaults option is specified as a function, then the function will be called using this Container as the\nscope (<code>this</code> reference) and passing the added item as the first parameter. Any resulting object\nfrom that call is then applied to the item as default properties.</p>\n\n\n<p>For example, to automatically apply padding to the body of each of a set of\ncontained <a href=\"#/api/Ext.panel.Panel\" rel=\"Ext.panel.Panel\" class=\"docClass\">Ext.panel.Panel</a> items, you could pass: <code>defaults: {bodyStyle:'padding:15px'}</code>.</p>\n\n\n<p>Usage:</p>\n\n\n<pre><code>defaults: {               // defaults are applied to items, not the container\n    autoScroll:true\n},\nitems: [\n    {\n        xtype: 'panel',   // defaults <b>do not</b> have precedence over\n        id: 'panel1',     // options in config objects, so the defaults\n        autoScroll: false // will not be applied here, panel1 will be autoScroll:false\n    },\n    new Ext.panel.Panel({       // defaults <b>do</b> have precedence over options\n        id: 'panel2',     // options in components, so the defaults\n        autoScroll: false // will be applied here, panel2 will be autoScroll:true.\n    })\n]</code></pre>\n\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "shortDoc": "Important: This config is only effective for collapsible Panels which are direct child items of a\nborder layout. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><strong>Important: This config is only effective for <a href=\"#/api/Ext.container.ButtonGroup-cfg-collapsible\" rel=\"Ext.container.ButtonGroup-cfg-collapsible\" class=\"docClass\">collapsible</a> Panels which are direct child items of a\n<a href=\"#/api/Ext.layout.container.Border\" rel=\"Ext.layout.container.Border\" class=\"docClass\">border layout</a>.</strong></p>\n\n<p>true to allow clicking a collapsed Panel's <a href=\"#/api/Ext.container.ButtonGroup-cfg-placeholder\" rel=\"Ext.container.ButtonGroup-cfg-placeholder\" class=\"docClass\">placeholder</a> to display the Panel floated above the layout,\nfalse to force the user to fully expand a collapsed region by clicking the expand button to see it again\n(defaults to true).</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><code>true</code> to hide the expand/collapse toggle button when <code><a href=\"#/api/Ext.container.ButtonGroup-cfg-collapsible\" rel=\"Ext.container.ButtonGroup-cfg-collapsible\" class=\"docClass\">collapsible</a> == true</code>, <code>false</code> to display it\n(defaults to <code>false</code>).</p>\n"
      },
      {
        "static": false,
        "type": "String",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p><code>true</code> to allow expanding and collapsing the panel (when <code><a href=\"#/api/Ext.container.ButtonGroup-cfg-collapsible\" rel=\"Ext.container.ButtonGroup-cfg-collapsible\" class=\"docClass\">collapsible</a> = true</code>) by clicking anywhere in\nthe header bar, <code>false</code>) to allow it only by clicking to tool button (defaults to <code>false</code>)).</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/Component.js",
        "doc": "<p>True to automatically call <a href=\"#/api/Ext.container.ButtonGroup-method-toFront\" rel=\"Ext.container.ButtonGroup-method-toFront\" class=\"docClass\">toFront</a> when the <a href=\"#/api/Ext.container.ButtonGroup-method-show\" rel=\"Ext.container.ButtonGroup-method-show\" class=\"docClass\">show</a> method is called\non an already visible, floating component (default is <code>true</code>).</p>\n\n"
      },
      {
        "static": false,
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>An array of <a href=\"#/api/Ext.panel.Tool\" rel=\"Ext.panel.Tool\" class=\"docClass\">Ext.panel.Tool</a> configs/instances to be added to the header tool area. The tools are stored as\nchild components of the header container. They can be accessed using <a href=\"#/api/Ext.container.ButtonGroup-method-down\" rel=\"Ext.container.ButtonGroup-method-down\" class=\"docClass\">down</a> and {#query}, as well as the\nother component methods. The toggle tool is automatically created if <a href=\"#/api/Ext.container.ButtonGroup-cfg-collapsible\" rel=\"Ext.container.ButtonGroup-cfg-collapsible\" class=\"docClass\">collapsible</a> is set to true.</p>\n\n<p>Note that, apart from the toggle tool which is provided when a panel is collapsible, these tools only provide the\nvisual button. Any required functionality must be provided by adding handlers that implement the necessary\nbehavior.</p>\n\n<p>Example usage:</p>\n\n<pre><code>tools:[{\n    type:'refresh',\n    tooltip: 'Refresh form Data',\n    // hidden:true,\n    handler: function(event, toolEl, panel){\n        // refresh logic\n    }\n},\n{\n    type:'help',\n    tooltip: 'Get Help',\n    handler: function(event, toolEl, panel){\n        // show help here\n    }\n}]\n</code></pre>\n"
      },
      {
        "static": false,
    ...
    "event": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is <a href=\"#/api/Ext.container.ButtonGroup-method-destroy\" rel=\"Ext.container.ButtonGroup-method-destroy\" class=\"docClass\">destroy</a>ed. Return false from an event handler to stop the <a href=\"#/api/Ext.container.ButtonGroup-method-destroy\" rel=\"Ext.container.ButtonGroup-method-destroy\" class=\"docClass\">destroy</a>.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is hidden when calling the <a href=\"#/api/Ext.container.ButtonGroup-method-hide\" rel=\"Ext.container.ButtonGroup-method-hide\" class=\"docClass\">hide</a> method.\nReturn false from an event handler to stop the hide.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires before the component is shown when calling the <a href=\"#/api/Ext.container.ButtonGroup-method-show\" rel=\"Ext.container.ButtonGroup-method-show\" class=\"docClass\">show</a> method.\nReturn false from an event handler to stop the show.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is <a href=\"#/api/Ext.container.ButtonGroup-method-destroy\" rel=\"Ext.container.ButtonGroup-method-destroy\" class=\"docClass\">destroy</a>ed.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is hidden.\nFires after the component is hidden when calling the <a href=\"#/api/Ext.container.ButtonGroup-method-hide\" rel=\"Ext.container.ButtonGroup-method-hide\" class=\"docClass\">hide</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Fires after the component is shown when calling the <a href=\"#/api/Ext.container.ButtonGroup-method-show\" rel=\"Ext.container.ButtonGroup-method-show\" class=\"docClass\">show</a> method.</p>\n"
      },
      {
        "static": false,
        "inheritable": false,
    ...
    "method": [
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "component",
            "doc": "<p>Either one or more Components to add or an Array of Components to add.\nSee <code><a href=\"#/api/Ext.container.ButtonGroup-property-items\" rel=\"Ext.container.ButtonGroup-property-items\" class=\"docClass\">items</a></code> for additional information.</p>\n"
          }
        ],
        "alias": null,
        "name": "add",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/AbstractComponent.js",
        "doc": "<p>Adds each argument passed to this method to the <a href=\"#/api/Ext.container.ButtonGroup-cfg-childEls\" rel=\"Ext.container.ButtonGroup-cfg-childEls\" class=\"docClass\">childEls</a> array.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Closes the Panel. By default, this method, removes it from the DOM, <a href=\"#/api/Ext.Component-method-destroy\" rel=\"Ext.Component-method-destroy\" class=\"docClass\">destroy</a>s the\nPanel object and all its descendant Components. The <a href=\"#/api/Ext.container.ButtonGroup-event-beforeclose\" rel=\"Ext.container.ButtonGroup-event-beforeclose\" class=\"docClass\">beforeclose</a> event is fired before the\nclose happens and will cancel the close action if it returns false.</p>\n\n<p><strong>Note:</strong> This method is not affected by the <a href=\"#/api/Ext.container.ButtonGroup-cfg-closeAction\" rel=\"Ext.container.ButtonGroup-cfg-closeAction\" class=\"docClass\">closeAction</a> setting which only affects the action triggered\nwhen clicking the <a href=\"#/api/Ext.container.ButtonGroup-cfg-closable\" rel=\"Ext.container.ButtonGroup-cfg-closable\" class=\"docClass\">'close' tool in the header</a>. To hide the Panel without destroying it, call\n<a href=\"#/api/Ext.container.ButtonGroup-method-hide\" rel=\"Ext.container.ButtonGroup-method-hide\" class=\"docClass\">hide</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Collapses the panel body so that the body becomes hidden. Docked Components parallel to the border towards which\nthe collapse takes place will remain visible. Fires the <a href=\"#/api/Ext.container.ButtonGroup-event-beforecollapse\" rel=\"Ext.container.ButtonGroup-event-beforecollapse\" class=\"docClass\">beforecollapse</a> event which will cancel the\ncollapse action if it returns false.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Expands the panel body so that it becomes visible. Fires the <a href=\"#/api/Ext.container.ButtonGroup-event-beforeexpand\" rel=\"Ext.container.ButtonGroup-event-beforeexpand\" class=\"docClass\">beforeexpand</a> event which will cancel the\nexpand action if it returns false.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/container/AbstractContainer.js",
        "doc": "<p>Inserts a Component into this Container at a specified index. Fires the\n<a href=\"#/api/Ext.container.ButtonGroup-event-beforeadd\" rel=\"Ext.container.ButtonGroup-event-beforeadd\" class=\"docClass\">beforeadd</a> event before inserting, then fires the <a href=\"#/api/Ext.container.ButtonGroup-method-add\" rel=\"Ext.container.ButtonGroup-method-add\" class=\"docClass\">add</a> event after the\nComponent has been inserted.</p>\n",
        "return": {
          "type": "Ext.Component",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.container.ButtonGroup-method-addListener\" rel=\"Ext.container.ButtonGroup-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "height",
            "doc": "<p>The new height to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new height in the <a href=\"#/api/Ext.container.ButtonGroup-method-getEl\" rel=\"Ext.container.ButtonGroup-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS height style.</li>\n<li><i>undefined</i> to leave the height unchanged.</li>\n</ul></div></p>\n"
          }
        ],
        "alias": null,
        "name": "setHeight",
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "width",
            "doc": "<p>The new width to set. This may be one of:<div class=\"mdetail-params\"><ul>\n<li>A Number specifying the new width in the <a href=\"#/api/Ext.container.ButtonGroup-method-getEl\" rel=\"Ext.container.ButtonGroup-method-getEl\" class=\"docClass\">Element</a>'s <a href=\"#/api/Ext.Element-property-defaultUnit\" rel=\"Ext.Element-property-defaultUnit\" class=\"docClass\">Ext.Element.defaultUnit</a>s (by default, pixels).</li>\n<li>A String used to set the CSS width style.</li>\n<li>A size object in the format <code>{width: widthValue, height: heightValue}</code>.</li>\n<li><code>undefined</code> to leave the width unchanged.</li>\n</ul></div></p>\n"
          },
          {
            "type": "Number/String",
            "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>Shortcut for performing an <a href=\"#/api/Ext.container.ButtonGroup-method-expand\" rel=\"Ext.container.ButtonGroup-method-expand\" class=\"docClass\">expand</a> or <a href=\"#/api/Ext.container.ButtonGroup-method-collapse\" rel=\"Ext.container.ButtonGroup-method-collapse\" class=\"docClass\">collapse</a> based on the current state of the panel.</p>\n",
        "return": {
          "type": "Ext.panel.Panel",
          "properties": null,
          "name": "return",
    ...
    "property": [
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/panel/Panel.js",
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.container.ButtonGroup-property-draggable\" rel=\"Ext.container.ButtonGroup-property-draggable\" class=\"docClass\">draggable</a>, this property will contain an instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> in order to\nsupply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.container.ButtonGroup-property-draggable\" rel=\"Ext.container.ButtonGroup-property-draggable\" class=\"docClass\">draggable</a>.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
