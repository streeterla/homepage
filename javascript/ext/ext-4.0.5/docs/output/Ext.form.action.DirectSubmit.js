Ext.data.JsonP.Ext_form_action_DirectSubmit({
  ...
  "html_filename": "DirectSubmit.html",
  "allMixins": [

  ],
  "docauthor": null,
  "href": "DirectSubmit.html#Ext-form-action-DirectSubmit",
  "subclasses": [
  ...
  "members": {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/extjs/src/form/action/Action.js",
        "doc": "<p>The function to call when a valid success return packet is received.\nThe function is passed the following parameters:<ul class=\"mdetail-params\">\n<li><b>form</b> : <a href=\"#/api/Ext.form.Basic\" rel=\"Ext.form.Basic\" class=\"docClass\">Ext.form.Basic</a><div class=\"sub-desc\">The form that requested the action</div></li>\n<li><b>action</b> : <a href=\"#/api/Ext.form.action.Action\" rel=\"Ext.form.action.Action\" class=\"docClass\">Ext.form.action.Action</a><div class=\"sub-desc\">The Action class. The <a href=\"#/api/Ext.form.action.DirectSubmit-property-result\" rel=\"Ext.form.action.DirectSubmit-property-result\" class=\"docClass\">result</a>\nproperty of this object may be examined to perform custom postprocessing.</div></li>\n</ul></p>\n"
      },
      {
        "static": false,
        "type": "Number",
