  ...
  "members": {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "doc": "<p>A config object containing one or more event handlers to be added to this object during initialization. This\nshould be a valid listeners config object as specified in the <a href=\"#/api/Ext.chart.LegendItem-method-addListener\" rel=\"Ext.chart.LegendItem-method-addListener\" class=\"docClass\">addListener</a> example for attaching multiple\nhandlers at once.</p>\n\n<p><strong>DOM events from ExtJS <a href=\"#/api/Ext.Component\" rel=\"Ext.Component\" class=\"docClass\">Components</a></strong></p>\n\n<p>While <em>some</em> ExtJs Component classes export selected DOM events (e.g. \"click\", \"mouseover\" etc), this is usually\nonly done when extra value can be added. For example the <a href=\"#/api/Ext.view.View\" rel=\"Ext.view.View\" class=\"docClass\">DataView</a>'s <strong><code><a href=\"#/api/Ext.view.View-event-itemclick\" rel=\"Ext.view.View-event-itemclick\" class=\"docClass\">itemclick</a></code></strong> event passing the node clicked on. To access DOM events directly from a\nchild element of a Component, we need to specify the <code>element</code> option to identify the Component property to add a\nDOM listener to:</p>\n\n<pre><code>new Ext.panel.Panel({\n    width: 400,\n    height: 200,\n    dockedItems: [{\n        xtype: 'toolbar'\n    }],\n    listeners: {\n        click: {\n            element: 'el', //bind to the underlying el property on the panel\n            fn: function(){ console.log('click el'); }\n        },\n        dblclick: {\n            element: 'body', //bind to the underlying body property on the panel\n            fn: function(){ console.log('dblclick body'); }\n        }\n    }\n});\n</code></pre>\n"
      }
    ],
    "css_mixin": [
    ...
    "method": [
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "keyFn",
            "doc": "<p>A function that can accept an item of the type(s) stored in this MixedCollection\nand return the key value for that item.  This is used when available to look up the key on items that\nwere passed without an explicit key parameter to a MixedCollection method.  Passing this parameter is\nequivalent to providing an implementation for the <a href=\"#/api/Ext.chart.LegendItem-method-getKey\" rel=\"Ext.chart.LegendItem-method-getKey\" class=\"docClass\">getKey</a> method.</p>\n"
          }
        ],
        "alias": null,
        "name": "constructor",
      ...
      },
      {
        ...
        "params": [
          {
            ...
            "optional": false,
            "name": "key",
            "doc": "<p>The key to associate with the item, or the new item.</p>\n\n\n<p>If a <a href=\"#/api/Ext.chart.LegendItem-method-getKey\" rel=\"Ext.chart.LegendItem-method-getKey\" class=\"docClass\">getKey</a> implementation was specified for this MixedCollection,\nor if the key of the stored items is in a property called <tt><b>id</b></tt>,\nthe MixedCollection will be able to <i>derive</i> the key for the new item.\nIn this case just pass the new item in this parameter.</p>\n\n"
          },
          {
            "type": "Object",
            "properties": [
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Adds an item to the collection. Fires the <a href=\"#/api/Ext.chart.LegendItem-method-add\" rel=\"Ext.chart.LegendItem-method-add\" class=\"docClass\">add</a> event when complete.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The method the event invokes.  Will be called with arguments given to\n<a href=\"#/api/Ext.chart.LegendItem-method-fireEvent\" rel=\"Ext.chart.LegendItem-method-fireEvent\" class=\"docClass\">fireEvent</a> plus the <code>options</code> parameter described below.</p>\n"
          },
          {
            "type": "Object",
            "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Removes all items from the collection.  Fires the <a href=\"#/api/Ext.chart.LegendItem-method-clear\" rel=\"Ext.chart.LegendItem-method-clear\" class=\"docClass\">clear</a> event when complete.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "alias": null,
        "name": "createLegend",
        "shortDoc": "Creates all the individual sprites for this legend item ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/chart/LegendItem.js",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Fires the specified event with the passed parameters (minus the event name, plus the <code>options</code> object passed\nto <a href=\"#/api/Ext.chart.LegendItem-method-addListener\" rel=\"Ext.chart.LegendItem-method-addListener\" class=\"docClass\">addListener</a>).</p>\n\n<p>An event may be set to bubble up an Observable parent hierarchy (See <a href=\"#/api/Ext.Component-method-getBubbleTarget\" rel=\"Ext.Component-method-getBubbleTarget\" class=\"docClass\">Ext.Component.getBubbleTarget</a>) by\ncalling <a href=\"#/api/Ext.chart.LegendItem-method-enableBubble\" rel=\"Ext.chart.LegendItem-method-enableBubble\" class=\"docClass\">enableBubble</a>.</p>\n",
        "return": {
          "type": "Boolean",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Returns the item associated with the passed key OR index.\nKey has priority over index.  This is the equivalent\nof calling <a href=\"#/api/Ext.chart.LegendItem-method-getByKey\" rel=\"Ext.chart.LegendItem-method-getByKey\" class=\"docClass\">getByKey</a> first, then if nothing matched calling <a href=\"#/api/Ext.chart.LegendItem-method-getAt\" rel=\"Ext.chart.LegendItem-method-getAt\" class=\"docClass\">getAt</a>.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Inserts an item at the specified index in the collection. Fires the <a href=\"#/api/Ext.chart.LegendItem-method-add\" rel=\"Ext.chart.LegendItem-method-add\" class=\"docClass\">add</a> event when complete.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.chart.LegendItem-method-addManagedListener\" rel=\"Ext.chart.LegendItem-method-addManagedListener\" class=\"docClass\">addManagedListener</a>.</p>\n\n<p>Adds listeners to any Observable object (or Ext.Element) which are automatically removed when this Component is\ndestroyed.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.chart.LegendItem-method-removeManagedListener\" rel=\"Ext.chart.LegendItem-method-removeManagedListener\" class=\"docClass\">removeManagedListener</a>.</p>\n\n<p>Removes listeners that were added by the <a href=\"#/api/Ext.chart.LegendItem-method-mon\" rel=\"Ext.chart.LegendItem-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.chart.LegendItem-method-addListener\" rel=\"Ext.chart.LegendItem-method-addListener\" class=\"docClass\">addListener</a>.</p>\n\n<p>Appends an event handler to this object.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Remove an item from a specified index in the collection. Fires the <a href=\"#/api/Ext.chart.LegendItem-method-remove\" rel=\"Ext.chart.LegendItem-method-remove\" class=\"docClass\">remove</a> event when complete.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "handler",
            "doc": "<p>The handler to remove. <strong>This must be a reference to the function passed into the\n<a href=\"#/api/Ext.chart.LegendItem-method-addListener\" rel=\"Ext.chart.LegendItem-method-addListener\" class=\"docClass\">addListener</a> call.</strong></p>\n"
          },
          {
            "type": "Object",
            "properties": [
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.chart.LegendItem-method-addListener\" rel=\"Ext.chart.LegendItem-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Removes listeners that were added by the <a href=\"#/api/Ext.chart.LegendItem-method-mon\" rel=\"Ext.chart.LegendItem-method-mon\" class=\"docClass\">mon</a> method.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/AbstractMixedCollection.js",
        "doc": "<p>Replaces an item in the collection. Fires the <a href=\"#/api/Ext.chart.LegendItem-method-replace\" rel=\"Ext.chart.LegendItem-method-replace\" class=\"docClass\">replace</a> event when complete.</p>\n",
        "return": {
          "type": "Object",
          "properties": null,
          "name": "return",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Resumes firing events (see <a href=\"#/api/Ext.chart.LegendItem-method-suspendEvents\" rel=\"Ext.chart.LegendItem-method-suspendEvents\" class=\"docClass\">suspendEvents</a>).</p>\n\n<p>If events were suspended using the <code>**queueSuspended**</code> parameter, then all events fired\nduring event suspension will be sent to any listeners now.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Suspends the firing of all events. (see <a href=\"#/api/Ext.chart.LegendItem-method-resumeEvents\" rel=\"Ext.chart.LegendItem-method-resumeEvents\" class=\"docClass\">resumeEvents</a>)</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/util/Observable.js",
        "doc": "<p>Shorthand for <a href=\"#/api/Ext.chart.LegendItem-method-removeListener\" rel=\"Ext.chart.LegendItem-method-removeListener\" class=\"docClass\">removeListener</a>.</p>\n\n<p>Removes an event handler.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "alias": null,
        "name": "updatePosition",
        "shortDoc": "Update the positions of all this item's sprites to match the root position\nof the legend box. ...",
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/chart/LegendItem.js",
