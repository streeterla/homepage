Ext.data.JsonP.Ext_data_ArrayStore({
  ...
  "members": {
    ...
    "event": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/AbstractStore.js",
        "doc": "<p>Fires whenever a successful write has been made via the configured <a href=\"#/api/Ext.data.ArrayStore-cfg-proxy\" rel=\"Ext.data.ArrayStore-cfg-proxy\" class=\"docClass\">Proxy</a></p>\n"
      }
    ],
    "method": [
      {
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Inserts Model instances into the Store at the given index and fires the <a href=\"#/api/Ext.data.ArrayStore-method-add\" rel=\"Ext.data.ArrayStore-method-add\" class=\"docClass\">add</a> event.\nSee also <code><a href=\"#/api/Ext.data.ArrayStore-method-add\" rel=\"Ext.data.ArrayStore-method-add\" class=\"docClass\">add</a></code>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": false,
            "name": "options",
            "doc": "<p>See options for <a href=\"#/api/Ext.data.ArrayStore-method-load\" rel=\"Ext.data.ArrayStore-method-load\" class=\"docClass\">load</a></p>\n"
          }
        ],
        "alias": null,
        "name": "loadPage",
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Loads an array of {@Ext.data.Model model} instances into the store, fires the datachanged event. This should only usually\nbe called internally when loading from the <a href=\"#/api/Ext.data.proxy.Proxy\" rel=\"Ext.data.proxy.Proxy\" class=\"docClass\">Proxy</a>, when adding records manually use <a href=\"#/api/Ext.data.ArrayStore-method-add\" rel=\"Ext.data.ArrayStore-method-add\" class=\"docClass\">add</a> instead</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/Store.js",
        "doc": "<p>Prefetches data into the store using its configured <a href=\"#/api/Ext.data.ArrayStore-cfg-proxy\" rel=\"Ext.data.ArrayStore-cfg-proxy\" class=\"docClass\">proxy</a>.</p>\n",
        "return": {
          "type": "undefined",
          "properties": [
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.data.ArrayStore-method-addListener\" rel=\"Ext.data.ArrayStore-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
  ...
  "component": false,
  "filename": "/Users/nickpoulden/Projects/sencha/SDK/platform/src/data/ArrayStore.js",
