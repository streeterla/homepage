    ...
    "cfg": [
      {
        ...
        "doc": "<p>Allow users to deselect a record in a DataView, List or Grid.\nOnly applicable when the <a href=\"#/api/Ext.selection.RowModel-cfg-mode\" rel=\"Ext.selection.RowModel-cfg-mode\" class=\"docClass\">mode</a> is 'SINGLE'. Defaults to false.</p>\n"
      },
      {
        "static": false,
        "type": "Boolean",
      ...
      },
      {
        ...
        "params": [
          ...
          },
          {
            ...
            "optional": true,
            "name": "scope",
            "doc": "<p>(optional) The scope originally specified for the handler. It must be the same as the\nscope argument specified in the original call to <a href=\"#/api/Ext.selection.RowModel-method-addListener\" rel=\"Ext.selection.RowModel-method-addListener\" class=\"docClass\">addListener</a> or the listener will not be removed.</p>\n"
          }
        ],
        "alias": null,
        "name": "removeListener",
